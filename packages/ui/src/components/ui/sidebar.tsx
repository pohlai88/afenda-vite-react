...
import { Skeleton } from '@afenda/ui/components/ui/skeleton'
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
  TooltipTrigger,
} from '@afenda/ui/components/ui/tooltip'
...
function Sidebar({
  ...
  return (
    <div
      className={cn(
        overflowing ? 'w-12' : '',
        'group peer relative hidden flex-shrink-0 text-sidebar-foreground md:block',
      )}
      data-state={state}
    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          'h-full w-(--sidebar-width) bg-transparent transition-[width] duration-100 ease-linear',
      ...
      <div
        ...
        data-side={side}
        className={cn(
          'absolute inset-y-0 z-10 hidden w-(--sidebar-width) transition-[left,right,width] duration-100 ease-linear data-[side=left]:left-0 data-[side=left]:group-data-[collapsible=offcanvas]:left-[calc(var(--sidebar-width)*-1)] data-[side=right]:right-0 data-[side=right]:group-data-[collapsible=offcanvas]:right-[calc(var(--sidebar-width)*-1)] md:flex',
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        'flex h-8 shrink-0 items-center rounded-xl px-3 text-xs font-medium text-sidebar-foreground/70 ring-sidebar-ring outline-hidden transition-[margin,opacity] duration-100 ease-linear group-data-[collapsible=icon]:-mt-8 group-data-[collapsible=icon]:opacity-0 focus-visible:ring-2 [&>svg]:size-5 [&>svg]:shrink-0',
        className,
      )}
      {...props}
    />
...
const sidebarMenuButtonVariants = cva(
  'peer/menu-button group/menu-button flex w-full items-center gap-2 overflow-hidden rounded-xl px-3 py-2 text-left text-sm text-foreground-lighter ring-sidebar-ring outline-hidden transition-[width,height,padding,color] duration-100 group-has-data-[sidebar=menu-action]/menu-item:pr-8 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-open:hover:bg-sidebar-accent data-open:hover:text-sidebar-accent-foreground data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium data-[active=true]:text-foreground [&>svg]:size-5 [&>svg]:shrink-0 [&>span:last-child]:truncate',
  {
    variants: {
      variant: {
