...
import { StatusIcon } from './sonner-status-icon'
    ...
    <Sonner
      ...
      toastOptions={{
        ...
        classNames: {
          ...
          actionButton: cn('block', buttonVariants({ variant: 'default', size: 'sm' })),
          cancelButton: cn('block', buttonVariants({ variant: 'outline', size: 'sm' })),
