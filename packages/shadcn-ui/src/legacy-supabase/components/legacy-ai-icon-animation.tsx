...
export interface LegacyAiIconAnimationProps {
  size?: number
  loading?: boolean
  className?: string
...
function LegacyAiIconAnimationComponent({
  size = 24,
  loading = false,
  className,
  allowHoverEffect = false,
}: LegacyAiIconAnimationProps) {
  ...
  return (
    <div
      className={cn("text-brand-600 relative flex items-center justify-center", className)}
...
export const LegacyAiIconAnimation = memo(LegacyAiIconAnimationComponent)
