 ...
 *
 * This module: `queries/query-primitives/effective-date-predicate.ts` — shared `effective_from` / `effective_to` predicates vs calendar `asOfDate` (validate date with `assertIsoDateOnly` first).
 */
