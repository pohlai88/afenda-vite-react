 ...
 *
 * This module: `src/schema/governance/governance-data-sources.schema.ts` — `governance.data_sources` integration/lineage catalog (priority rank, authoritative flag); aligns with `docs/guideline/` data-source intent.
 */
