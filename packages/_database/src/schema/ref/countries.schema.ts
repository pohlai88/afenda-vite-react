 ...
 *
 * This module: `src/schema/ref/countries.schema.ts` — `ref.countries` ISO 3166-1 alpha-2 PK; FK target for `mdm.tenants.country_code`.
 */
import { countryCodeColumn } from "../shared/columns.schema"
