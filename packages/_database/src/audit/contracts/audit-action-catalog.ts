...
export const auditActionCatalog = {
  ...
  "auth.session.created": {
    key: "auth.session.created",
    category: "authentication",
    risk: "medium",
    truthImpact: false,
    requiresReason: false,
    requiresResolutionRef: false,
    description: "Better Auth persisted a new session (e.g. sign-in).",
  },
  "auth.session.revoked": {
    ...
    requiresResolutionRef: false,
    description:
      "Better Auth removed a session (sign-out, revocation, expiry cleanup).",
  },
  "auth.account.linked": {
    key: "auth.account.linked",
    category: "authentication",
    risk: "medium",
    truthImpact: false,
    requiresReason: false,
    requiresResolutionRef: false,
    description: "A provider or credential account row was created for a user.",
  },
  "auth.user.updated": {
    ...
    requiresResolutionRef: false,
    description:
      "Better Auth user profile row was updated (e.g. email or name).",
  },
  "invoice.created": {
    key: "invoice.created",
    category: "billing",
