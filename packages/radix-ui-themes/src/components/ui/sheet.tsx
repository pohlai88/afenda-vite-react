...
export function SheetOverlay({ className, ref, ...props }: DialogPrimitive.DialogOverlayProps & { ref?: Ref<HTMLDivElement> }) {
...
export function SheetContent({
  ...
  ref,
  ...props
}: DialogPrimitive.DialogContentProps & VariantProps<typeof sheetVariants> & { ref?: Ref<HTMLDivElement> }) {
  return (
    <SheetPortal>
      <SheetOverlay />
