  ...
  return defineConfig([
...

    {
      ...
      files: [
        ...
        "packages/shadcn-ui/src/components/ui/chart.tsx",
      ],
      plugins: {
        "afenda-ui": afendaUiPlugin,
      },
      ...
      rules: {
        ...
        "no-restricted-syntax": [
          "error",
          {
            ...
            message:
              "Use the shared VisuallyHidden primitive instead of raw sr-only JSX in packages/shadcn-ui.",
          },
        ],
      },
    },
    ...
    {
      name: "packages/shadcn-ui/base-ui-boundary",
      files: ["packages/shadcn-ui/src/**/*.{ts,tsx}"],
      ignores: ["packages/shadcn-ui/src/components/ui/combobox.tsx"],
      rules: {
            ...
            paths: [
              {
                name: "@base-ui/react",
                message:
                  "Use radix-ui primitives in packages/shadcn-ui. The only approved @base-ui/react exception is packages/shadcn-ui/src/components/ui/combobox.tsx.",
              },
            ],
          },
        ],
