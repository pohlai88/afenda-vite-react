...
| ------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [External dependencies portal — architecture (idea)](./external-dependencies-portal-architecture.md)               | This deliberately does not embed third-party dashboards in iframes (most vendors block it). “Embedding” means curated deep links + RBAC, not iframes.                      |
...
| [Turbo / CI: test:run graph check (workspace upgrade)](./turbo-ci-workspace-upgrade-test.md)                       | Review the task list for packages you care about; scope is larger and slower when executed without --dry-run.                                                              |
