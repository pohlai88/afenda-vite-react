...
**Status:** **Planned** for **`apps/web`** — **`tailwindcss`** / **`@tailwindcss/vite`** are **not** in [`apps/web/package.json`](../../apps/web/package.json) today. Global CSS entry: [`apps/web/src/index.css`](../../apps/web/src/index.css) (plain CSS variables today; see [Components and styling](../COMPONENTS_AND_STYLING.md)). **`@` → `./src`** is **already** set in [`apps/web/vite.config.ts`](../../apps/web/vite.config.ts) for shadcn-style imports.
