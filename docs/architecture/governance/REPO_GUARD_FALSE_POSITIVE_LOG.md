...
| 2026-04-23 | `RG-TRUTH-002`    | `RG-TRUTH-002`    | Repo guard treated the governance register as one of its own authenticity surfaces, creating a circular dependency with the governance spine                | `false-positive` | Remove governance-register authenticity ownership from repo guard and leave that surface to governance-spine evidence checks                                             | `no`          | `governance-toolchain` | Fixed in the same pass; this was a control-plane boundary mistake, not real generated drift                                                       |
| 2026-04-23 | `RG-TRUTH-004`    | `RG-TRUTH-004`    | Repo-guard architecture discovery bindings treated ordinary doctrine prose edits as mandatory discovery-surface refreshes                                   | `false-positive` | Remove the over-broad discovery binding from live mismatch policy and defer it until discovery-significant metadata can be detected reliably                             | `no`          | `governance-toolchain` | Fixed in the same pass; keeps the guard high-confidence instead of inferring stale evidence from unrelated prose edits                            |

## Recorded warned-cycle reviews

| Date       | Review type                  | Repo-guard verdict | Promotion review verdict | New findings | False positives opened | Waivers added | Outcome          | Notes                                                                                                                                                                                                                                                                      |
| ---------- | ---------------------------- | ------------------ | ------------------------ | ------------ | ---------------------- | ------------- | ---------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-04-23 | `baseline clean-tree review` | `pass`             | `warn`                   | `0`          | `0`                    | `0`           | `hold at warned` | First bounded warned-cycle review recorded. Remaining blocker is manual promotion criteria, not live repo drift. See [REPO_GUARD_PROMOTION_REVIEW_2026-04-23.md](/C:/NexusCanon/afenda-react-vite/docs/architecture/governance/REPO_GUARD_PROMOTION_REVIEW_2026-04-23.md). |
