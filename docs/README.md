...
| [Coding guardrails](./CODING_GUARDRAILS.md)                     | docs     | Read first | canonical  | canonical-doc  | governance-toolchain | Practical fail-first coding workflow, recommended local skill stack, and pre-deploy validation ladder for the Afenda monorepo.       |
