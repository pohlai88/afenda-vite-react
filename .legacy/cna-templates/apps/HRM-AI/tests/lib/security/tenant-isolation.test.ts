...
describe("Multi-tenant Security", () => {
  ...
  describe("Tenant Scoped Operations", () => {
    ...
    function scopeCreateInput(
      input: CreateInput,
      tenantId: string
    ): CreateInputWithTenant {
      return {
        ...input,
        tenantId,
      }
  ...
  describe("API Route Protection", () => {
    ...
    it("should reject requests without context", () => {
      const handler: ProtectedHandler<{ data: string }> = async () => ({
        data: "test",
      })
