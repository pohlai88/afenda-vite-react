...
describe("Attendance Service", () => {
  ...
  describe("Late/Early Detection", () => {
    ...
    function calculateEarlyMinutes(checkOut: Date, shiftEnd: Date): number {
  ...
  describe("Attendance Status", () => {
    ...
    it("should return PRESENT for on-time attendance", () => {
      expect(determineStatus(true, true, false, false, "WORKING")).toBe(
        "PRESENT"
      )
    })
    ...
    it("should return EARLY_LEAVE for early check-out", () => {
      expect(determineStatus(true, true, false, true, "WORKING")).toBe(
        "EARLY_LEAVE"
      )
    })

    it("should return ABSENT for no check-in", () => {
      expect(determineStatus(false, false, false, false, "WORKING")).toBe(
        "ABSENT"
      )
    })

    it("should return HOLIDAY for holiday", () => {
      expect(determineStatus(false, false, false, false, "HOLIDAY")).toBe(
        "HOLIDAY"
      )
    })

    it("should return WEEKEND for weekend", () => {
      expect(determineStatus(false, false, false, false, "WEEKEND")).toBe(
        "WEEKEND"
      )
    })
  ...
  describe("Location Validation", () => {
    ...
    it("should validate location within range", () => {
      ...
      const user = { latitude: 10.777, longitude: 106.701 } // Very close
    ...
    it("should reject location outside range", () => {
      ...
      const user = { latitude: 10.8, longitude: 106.7009 } // ~2.5km away
