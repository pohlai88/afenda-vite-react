...
describe("Department Service", () => {
  ...
  describe("create", () => {
    it("should create department with required fields", async () => {
      ...
      vi.mocked(db.department.create).mockResolvedValue({
        id: "new-1",
        name: "IT",
        code: "IT",
      } as never)
  ...
  describe("update", () => {
    it("should update department if exists", async () => {
      ...
      const result = await departmentService.update("tenant-1", "1", {
        name: "Updated IT",
      })
    ...
    it("should only update provided fields", async () => {
      ...
      await departmentService.update("tenant-1", "1", {
  ...
  describe("delete", () => {
    ...
    it("should throw if department has children", async () => {
      ...
      await expect(departmentService.delete("tenant-1", "1")).rejects.toThrow(
