...
describe("Payroll Calculation Service", () => {
  ...
  describe("PIT Calculation Integration", () => {
    ...
    it("should calculate assessable income correctly", () => {
      ...
      const assessable = calculateAssessableIncome(
        taxableIncome,
        insurance,
        dependents
      )
  ...
  describe("Net Salary Calculation", () => {
    ...
    function calculateNetSalary(
      ...
      const totalDeductions =
        deductions.insurance + deductions.pit + deductions.other
      ...
      const records: PayrollRecord[] = [
        {
          ...
          netSalary: 24_700_000,
          totalEarnings: 30_000_000,
          totalDeductions: 5_300_000,
          employerCost: 36_450_000,
        },
        {
          grossSalary: 20_000_000,
          netSalary: 17_100_000,
          totalEarnings: 20_000_000,
          totalDeductions: 2_900_000,
  ...
  describe("Bonus Calculation", () => {
    ...
    function calculateBonus(
      ...
      switch (config.type) {
        ...
        case "PERCENTAGE":
          const base =
            config.basedOn === "GROSS_SALARY"
              ? salaryData.grossSalary
              : config.basedOn === "NET_SALARY"
    ...
    it("should calculate fixed bonus", () => {
      ...
      const result = calculateBonus(config, {
