...
test.describe("Login Flow", () => {
  ...
  test.describe("Failed Login", () => {
    test("should show error for invalid email", async () => {
      ...
      await loginPage.expectErrorMessage(
        /email hoặc mật khẩu không đúng|invalid credentials/i
      )
  ...
  test.describe("Security", () => {
    ...
    test("should handle SQL injection attempt gracefully", async () => {
      ...
      await loginPage.expectErrorMessage(
        /email hoặc mật khẩu không đúng|invalid/i
      )
    })
  ...
  test.describe("Redirects", () => {
    ...
    test("should redirect to dashboard for direct login page access", async ({
      page,
    }) => {
      await page.goto("/login")
      const loginPage = new LoginPage(page)
  ...
  test.describe("Accessibility", () => {
    test("should have proper labels for form fields", async ({ page }) => {
      ...
      const passwordLabel = page.locator(
        'label[for="password"], label:has-text("Mật khẩu")'
      )
