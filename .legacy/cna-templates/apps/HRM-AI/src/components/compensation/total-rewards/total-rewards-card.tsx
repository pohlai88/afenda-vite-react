  ...
  const items = [
    {
      ...
      label: "Lương cơ bản (năm)",
      value: statement.baseSalary * 12,
      color: "text-blue-600",
    },
    {
      icon: <Wallet className="w-4 h-4" />,
      label: "Phụ cấp",
      value: statement.totalAllowances,
      color: "text-green-600",
    },
    {
      icon: <Gift className="w-4 h-4" />,
      label: "Phúc lợi",
      value: statement.totalBenefitsValue,
      color: "text-purple-600",
    },
    {
      icon: <Shield className="w-4 h-4" />,
      label: "BHXH (Công ty)",
      value: statement.employerContributions,
      ...
      <CardContent className="space-y-4">
        ...
        <div className="border-t pt-3 flex items-center justify-between">
          ...
          <span className="font-bold text-lg text-primary font-mono">
            {formatCurrency(statement.totalRewards)}
          </span>
        </div>
      </CardContent>
    </Card>
