...
const TYPE_ICONS: Record<string, React.ReactNode> = {
  ...
  OPTIONAL: <Gift className="w-4 h-4" />,
  ALLOWANCE: <Wallet className="w-4 h-4" />,
  PERK: <Star className="w-4 h-4" />,
}
...
export function BenefitPlanCard({
  plan,
  onEnroll,
  enrolled,
