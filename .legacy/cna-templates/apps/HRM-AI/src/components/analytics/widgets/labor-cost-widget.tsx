          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              >
                ...
                <span>
                  {Math.abs(data.change).toFixed(1)}% so với tháng trước
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-1.5 text-xs">
            <div className="flex items-center justify-between">
              ...
              <span className="font-medium">
                {formatCurrency(data.breakdown.salary)}
              </span>
            </div>
            <div className="flex items-center justify-between">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="font-medium">
                {formatCurrency(data.breakdown.insurance)}
              </span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-muted-foreground">Khác</span>
              <span className="font-medium">
                {formatCurrency(data.breakdown.other)}
              </span>
            </div>
          </div>
        </div>
