...
export const COMPA_RATIO_RANGES = [
  { min: 0, max: 0.8, label: "Below 80%", status: "critical" },
  { min: 0.8, max: 0.9, label: "80-90%", status: "warning" },
  { min: 0.9, max: 1.0, label: "90-100%", status: "normal" },
  { min: 1.0, max: 1.1, label: "100-110%", status: "normal" },
  { min: 1.1, max: 1.2, label: "110-120%", status: "warning" },
  { min: 1.2, max: Infinity, label: "Above 120%", status: "critical" },
]
...
export const DEFAULT_MERIT_MATRIX: MeritMatrixData = {
  ...
  compaRatioRanges: [
    ...
    { min: 1.0, max: 1.1, label: "100-110%" },
    { min: 1.1, max: 1.2, label: "110-120%" },
  ],
  cells: {
