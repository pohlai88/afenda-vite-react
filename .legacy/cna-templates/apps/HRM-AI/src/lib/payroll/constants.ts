...
export const PIT_BRACKETS = [
  ...
  { from: 5_000_000, to: 10_000_000, rate: 0.1 }, // 10%
  { from: 10_000_000, to: 18_000_000, rate: 0.15 }, // 15%
  { from: 18_000_000, to: 32_000_000, rate: 0.2 }, // 20%
  { from: 32_000_000, to: 52_000_000, rate: 0.25 }, // 25%
  { from: 52_000_000, to: 80_000_000, rate: 0.3 }, // 30%
...
export const DEFAULT_SALARY_COMPONENTS = [
  ...
  },
  {
    ...
    category: "ALLOWANCE_NON_TAXABLE",
    itemType: "EARNING",
    isTaxable: false,
    isInsuranceable: false,
    isSystem: false,
