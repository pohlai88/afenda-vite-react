...
export const JOB_POSTING_STATUS: Record<
  string,
  { label: string; color: string }
> = {
  DRAFT: { label: "Nháp", color: "gray" },
...
export const APPLICATION_STATUS: Record<
  string,
  { label: string; color: string; stage: number }
> = {
...
export const INTERVIEW_RESULT: Record<
  string,
  { label: string; color: string }
> = {
...
export const ONBOARDING_TASK_STATUS: Record<
  string,
  { label: string; color: string }
> = {
...
export const ONBOARDING_CATEGORY: Record<
  string,
