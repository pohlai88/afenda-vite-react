...
export function calculateOverallReviewScore(
  ...
  if (competencyScore !== null)
    items.push({ score: competencyScore, weight: weights.competency })
  if (valuesScore !== null)
    items.push({ score: valuesScore, weight: weights.values })
  if (feedbackScore !== null)
    items.push({ score: feedbackScore, weight: weights.feedback })
