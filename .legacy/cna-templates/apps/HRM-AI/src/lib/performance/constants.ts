...
export const REVIEW_STATUS = {
  ...
  MANAGER_REVIEW_PENDING: {
    label: "Chờ quản lý đánh giá",
    color: "yellow",
    step: 3,
  },
  MANAGER_REVIEW_DONE: {
    label: "Quản lý đã đánh giá",
    color: "yellow",
    step: 4,
  },
...
export const RATING_SCALE = [
  {
    value: 5,
    label: "Exceptional",
    description: "Vượt xa kỳ vọng, role model",
    color: "#22c55e",
  },
  {
    value: 4,
    label: "Exceeds",
    description: "Vượt kỳ vọng, high performer",
    color: "#84cc16",
  },
  {
    value: 3,
    label: "Meets",
    description: "Đạt kỳ vọng, solid contributor",
    color: "#eab308",
  },
  {
    value: 2,
    label: "Developing",
    description: "Cần cải thiện, below expectations",
    color: "#f97316",
  },
  {
    value: 1,
    label: "Unsatisfactory",
    description: "Không đạt, significant gap",
    color: "#ef4444",
  },
] as const
