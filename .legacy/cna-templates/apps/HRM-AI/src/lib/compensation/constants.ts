export const COMPENSATION_REVIEW_STATUS: Record<
  string,
...
export const BENEFIT_ENROLLMENT_STATUS: Record<
  string,
  { label: string; color: string }
> = {
...
export const COMPENSATION_CYCLE_STATUS: Record<
  string,
  { label: string; color: string }
> = {
...
export const DEFAULT_MERIT_MATRIX = [
  ...
  },
  {
    ...
    compaRatioMin: 0.9,
    compaRatioMax: 1.1,
    meritIncreasePercent: 2,
  },
  {
    performanceRating: 2,
    compaRatioMin: 1.1,
    compaRatioMax: 1.2,
    meritIncreasePercent: 1,
  },
  {
    performanceRating: 2,
    compaRatioMin: 1.2,
  ...
  // Performance 3
  {
    ...
    compaRatioMin: 0,
    compaRatioMax: 0.8,
    meritIncreasePercent: 8,
  },
  {
    performanceRating: 3,
    compaRatioMin: 0.8,
    compaRatioMax: 0.9,
    meritIncreasePercent: 6,
  },
  {
    performanceRating: 3,
    compaRatioMin: 0.9,
  ...
  // Performance 4
  {
    ...
    compaRatioMin: 0,
    compaRatioMax: 0.8,
    meritIncreasePercent: 12,
  },
  {
    performanceRating: 4,
    compaRatioMin: 0.8,
    compaRatioMax: 0.9,
    meritIncreasePercent: 9,
  },
  {
    performanceRating: 4,
    compaRatioMin: 0.9,
    compaRatioMax: 1.1,
    meritIncreasePercent: 7,
  },
  {
    performanceRating: 4,
    compaRatioMin: 1.1,
    compaRatioMax: 1.2,
    meritIncreasePercent: 5,
  },
  {
    performanceRating: 4,
    compaRatioMin: 1.2,
