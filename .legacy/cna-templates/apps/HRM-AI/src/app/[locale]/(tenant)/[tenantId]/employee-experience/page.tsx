...
export const metadata: Metadata = {
  ...
  description:
    "Employee engagement, surveys, recognition, and communication hub",
}
  ...
  const modules = [
    {
      title: "Pulse Surveys",
      description:
        "Measure employee engagement with quick surveys and eNPS tracking",
      icon: ClipboardList,
        ...
        <CardContent>
          <div className="space-y-4">
            <div className="flex items-center gap-4 p-3 rounded-lg bg-muted/50">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium">
                  Nguyen Van A gave kudos to Tran Thi B
                </p>
                <p className="text-xs text-muted-foreground">
                  Team Player - 2 hours ago
                </p>
              </div>
            </div>
            <div className="flex items-center gap-4 p-3 rounded-lg bg-muted/50">
            ...
            <div className="flex items-center gap-4 p-3 rounded-lg bg-muted/50">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium">
                  New announcement: Q4 Company Update
                </p>
                <p className="text-xs text-muted-foreground">
                  Posted by CEO - 2 days ago
                </p>
              </div>
            </div>
          </div>
