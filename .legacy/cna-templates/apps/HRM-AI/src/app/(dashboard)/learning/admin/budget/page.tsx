    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Theo doi va quan ly ngan sach dao tao
          </p>
        </div>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-muted-foreground">Da chi</p>
                <p className="text-xl font-bold">
                  {budget ? formatCurrency(budget.spent) : "0"}
                </p>
              </div>
            </div>
          </CardContent>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-muted-foreground">Cam ket</p>
                <p className="text-xl font-bold">
                  {budget ? formatCurrency(budget.committed) : "0"}
                </p>
              </div>
            </div>
          </CardContent>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-muted-foreground">Con lai</p>
                <p className="text-xl font-bold">
      ...
      {budget && (
        <>
          <Card>
            <CardHeader>
              <CardTitle>Ngan sach theo phong ban</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              <CardTitle>Chi phi theo danh muc</CardTitle>
            </CardHeader>
            <CardContent>
