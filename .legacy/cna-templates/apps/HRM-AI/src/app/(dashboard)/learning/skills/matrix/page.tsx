    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs">Xuất sắc (4-5)</span>
        </div>
        <div className="flex items-center gap-2">
          <div className="w-4 h-4 rounded bg-blue-500" />
          <span className="text-xs">Khá (3)</span>
        </div>
        <div className="flex items-center gap-2">
          <div className="w-4 h-4 rounded bg-yellow-500" />
          <span className="text-xs">Trung bình (2)</span>
        </div>
        <div className="flex items-center gap-2">
          <div className="w-4 h-4 rounded bg-orange-500" />
          <span className="text-xs">Cơ bản (1)</span>
        </div>
      </div>
                  ...
                  <tr key={i} className="border-b">
                    ...
                    {(entry.employees || []).map((emp, j) => (
                      <td key={j} className="text-center p-2">
                        <div
                          className={`w-6 h-6 rounded mx-auto ${getLevelColor(emp.level)} flex items-center justify-center text-white text-xs font-bold`}
                        >
                          {emp.level}
                        </div>
                      </td>
