...
export default function TrainingRequestsPage() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case "approved":
        return <Badge className="bg-green-500">Da duyet</Badge>
      case "pending":
        return <Badge variant="secondary">Cho duyet</Badge>
      case "rejected":
        return <Badge variant="destructive">Tu choi</Badge>
      default:
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Quan ly yeu cau tham gia dao tao
          </p>
        </div>
