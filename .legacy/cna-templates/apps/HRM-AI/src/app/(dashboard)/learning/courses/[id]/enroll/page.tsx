  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Chọn lịch học và hoàn tất đăng ký
        </p>
      </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Chọn buổi học</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          {sessions.length === 0 ? (
            <p className="text-sm text-muted-foreground">
              Khóa học online - không cần chọn lịch cụ thể
            </p>
          ) : (
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <Badge variant="secondary">
                      {session.availableSlots} chỗ trống
                    </Badge>
                  </div>
                </div>
              ))}
      ...
      <Card>
        <CardHeader>
          <CardTitle>Lý do đăng ký</CardTitle>
        </CardHeader>
        <CardContent>
          <Label htmlFor="reason">
            Mô tả lý do bạn muốn tham gia khóa học này
          </Label>
          <Textarea
            id="reason"
            value={reason}
