  ...
  try {
    ...
    return NextResponse.json({
      ...
      data: {
        ...
        formatted: {
          baseSalary:
            new Intl.NumberFormat("vi-VN").format(contribution.baseSalary) +
            " VND",
          employeeTotal:
            new Intl.NumberFormat("vi-VN").format(contribution.employee.total) +
            " VND",
          employerTotal:
            new Intl.NumberFormat("vi-VN").format(contribution.employer.total) +
            " VND",
          grandTotal:
            new Intl.NumberFormat("vi-VN").format(contribution.total) + " VND",
        },
      },
    })
  } catch (error) {
