...
test.describe("Employee List", () => {
  ...
  test("should paginate through employees", async ({
    page,
    employeeListPage,
  }) => {
  ...
  test("should sort employees by column", async ({
    page,
    employeeListPage,
  }) => {
  ...
  test("should navigate to employee detail", async ({
    page,
    employeeListPage,
  }) => {
...
test.describe("Employee Edit", () => {
  ...
  test("should edit employee successfully", async ({ page }) => {
    ...
    // Click edit button
    await page.click(
      '[data-testid="edit-button"], button:has-text("Chỉnh sửa")'
    )
