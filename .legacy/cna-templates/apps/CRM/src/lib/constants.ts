export const DEFAULT_STAGES = [
  {
    name: "New Lead",
    labelKey: "pipeline.stageNewLead",
    order: 0,
    probability: 10,
    color: "#6B7280",
    isWon: false,
  ...
  {
    name: "Qualification",
    labelKey: "pipeline.stageQualification",
    order: 1,
    probability: 20,
    color: "#3B82F6",
    isWon: false,
  ...
  {
    name: "Proposal",
    labelKey: "pipeline.stageProposal",
    order: 2,
    probability: 50,
    color: "#8B5CF6",
    isWon: false,
  ...
  {
    name: "Negotiation",
    labelKey: "pipeline.stageNegotiation",
    order: 3,
    probability: 75,
    color: "#F59E0B",
    isWon: false,
  ...
  {
    name: "Closed Won",
    labelKey: "pipeline.stageClosedWon",
    order: 4,
    probability: 100,
    color: "#10B981",
    isWon: true,
  ...
  {
    name: "Closed Lost",
    labelKey: "pipeline.stageClosedLost",
    order: 5,
    probability: 0,
    color: "#EF4444",
    isWon: false,
...
export const ORDER_STATUSES = [
  ...
  {
    value: "IN_PRODUCTION",
    labelKey: "orderStatus.inProduction",
    color: "#8B5CF6",
  },
...
export const DEAL_CONTACT_ROLES = [
  {
    ...
    labelKey: "dealRole.decisionMaker",
    color: "#EF4444",
    icon: "Crown",
  },
  {
    value: "BUDGET_HOLDER",
    labelKey: "dealRole.budgetHolder",
    color: "#F59E0B",
    icon: "DollarSign",
  },
  {
    value: "TECHNICAL_EVALUATOR",
    labelKey: "dealRole.technicalEvaluator",
    color: "#3B82F6",
    icon: "Cpu",
  },
  {
    value: "INFLUENCER",
    labelKey: "dealRole.influencer",
    color: "#EC4899",
    icon: "Megaphone",
  },
  {
    value: "CHAMPION",
    labelKey: "dealRole.champion",
    color: "#10B981",
    icon: "Star",
  },
  {
    value: "GATEKEEPER",
    labelKey: "dealRole.gatekeeper",
    color: "#6366F1",
    icon: "Shield",
  },
  {
    value: "END_USER",
    labelKey: "dealRole.endUser",
    color: "#6B7280",
    icon: "User",
  },
  {
    value: "PROCUREMENT",
    labelKey: "dealRole.procurement",
    color: "#8B5CF6",
    icon: "FileText",
  },
  {
    value: "OTHER",
    labelKey: "dealRole.other",
    color: "#9CA3AF",
    icon: "MoreHorizontal",
  },
] as const
...
export const COMPLIANCE_STATUSES = [
  ...
  { value: "BLOCKED", labelKey: "compliance.blocked", color: "#EF4444" },
  {
    ...
    labelKey: "compliance.reviewRequired",
    color: "#3B82F6",
  },
] as const
...
> = {
  ...
  ACADEMIC: [
    ...
    {
      key: "research_purpose_verified",
      labelKey: "checklist.researchPurposeVerified",
    },
  ],
}
...
export const PRODUCT_CATEGORIES = [
  ...
  {
    value: "TRAINING",
    labelKey: "products.category.TRAINING",
    icon: "GraduationCap",
  },
  {
    value: "MAINTENANCE",
    labelKey: "products.category.MAINTENANCE",
    icon: "Wrench",
  },
  { value: "SOFTWARE", labelKey: "products.category.SOFTWARE", icon: "Code" },
  {
    value: "SPARE_PART",
    labelKey: "products.category.SPARE_PART",
    icon: "Cog",
  },
  {
    value: "ACCESSORY",
    labelKey: "products.category.ACCESSORY",
    icon: "Puzzle",
  },
...
export const BUNDLE_TYPES = [
  ...
  {
    value: "SERVICE_PLAN",
    labelKey: "bundles.type.SERVICE_PLAN",
    color: "#10B981",
  },
] as const
...
export const CUSTOMER_TIERS = [
  {
    value: "GOVERNMENT",
    labelKey: "bundles.tier.GOVERNMENT",
    color: "#1D4ED8",
  },
  {
    value: "COMMERCIAL",
    labelKey: "bundles.tier.COMMERCIAL",
    color: "#10B981",
  },
...
export const PARTNER_TYPES = [
  ...
  {
    value: "INTEGRATOR",
    labelKey: "partner.type.integrator",
    color: "#8B5CF6",
  },
  {
    value: "DISTRIBUTOR",
    labelKey: "partner.type.distributor",
    color: "#F59E0B",
  },
  ...
  {
    value: "CONSULTANT",
    labelKey: "partner.type.consultant",
    color: "#6366F1",
  },
] as const
...
export const COMMISSION_STATUSES = [
  {
    value: "PENDING",
    labelKey: "partner.commission.pending",
    color: "#F59E0B",
  },
  {
    value: "APPROVED",
    labelKey: "partner.commission.approved",
    color: "#3B82F6",
  },
  { value: "PAID", labelKey: "partner.commission.paid", color: "#10B981" },
  {
    value: "CANCELLED",
    labelKey: "partner.commission.cancelled",
    color: "#EF4444",
  },
] as const
...
export const COUNTRIES = [
  {
    code: "US",
    name: { en: "United States", vi: "Hoa Kỳ" },
  ...
  {
    code: "AE",
    name: { en: "UAE", vi: "Các Tiểu Vương Quốc Ả Rập" },
    region: "Middle East",
  },
  ...
  {
    code: "SG",
    name: { en: "Singapore", vi: "Singapore" },
    region: "Southeast Asia",
  },
  {
    code: "TH",
  ...
  {
    code: "PH",
    name: { en: "Philippines", vi: "Philippines" },
    region: "Southeast Asia",
  },
  {
    code: "SA",
    name: { en: "Saudi Arabia", vi: "Ả Rập Saudi" },
    region: "Middle East",
  },
