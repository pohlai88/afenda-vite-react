      ...
      <div className="bg-white rounded-xl border border-gray-200 p-3">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-sm">
          ...
          <div>
            ...
            <p
              className={`mt-0.5 ${order.paidAt ? "text-emerald-600" : "text-amber-500"}`}
            >
        ...
        <table className="w-full mt-2">
          <thead>
            <tr className="border-b border-gray-100 bg-gray-50">
              <th className="text-left text-xs font-medium text-gray-500 uppercase tracking-wide px-4 py-2">
                #
              </th>
              <th className="text-left text-xs font-medium text-gray-500 uppercase tracking-wide px-4 py-2">
                Sản phẩm
              </th>
              <th className="text-right text-xs font-medium text-gray-500 uppercase tracking-wide px-4 py-2">
                SL
              </th>
              <th className="text-right text-xs font-medium text-gray-500 uppercase tracking-wide px-4 py-2">
                Đơn giá
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-3">
          ...
          <div className="space-y-3">
            {order.statusHistory.map((entry: any) => {
              const from = STATUS_LABELS[entry.fromStatus] || {
                label: entry.fromStatus,
                color: "#6B7280",
              }
              const to = STATUS_LABELS[entry.toStatus] || {
