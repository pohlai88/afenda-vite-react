                ...
                >
                  <TableCell>
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm text-[var(--crm-text-primary)] font-medium">
                        {member.name}
                      </span>
                    </div>
                  </TableCell>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          {Object.entries(ROLE_CONFIG).map(([key, config]) => {
            ...
            return (
              <div
                key={key}
                className="flex items-start gap-3 p-3 rounded-md bg-[var(--glass-bg)] border border-[var(--crm-border-subtle)]"
              >
                <div
                ...
                <div>
                  ...
                  <p className="text-xs text-[var(--crm-text-muted)] mt-0.5">
                    ...
                    {key === "MANAGER" &&
                      "Quản lý thương vụ, báo cáo, phân công"}
                    {key === "MEMBER" &&
                      "Tạo và quản lý thương vụ, liên hệ, hoạt động"}
