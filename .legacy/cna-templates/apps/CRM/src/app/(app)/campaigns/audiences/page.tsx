          ...
          {audiences.map((audience: any) => (
            <div key={audience.id} className="glass-card-static p-3">
              ...
              <div className="flex items-center gap-2">
                <Badge
                  className="badge-premium border-0 text-[10px]"
                  style={{
                    backgroundColor:
                      audience.type === "DYNAMIC" ? "#8B5CF620" : "#3B82F620",
                ...
                {audience.type === "DYNAMIC" ? (
                  <span className="text-xs text-[var(--crm-text-muted)]">
                    {t("audiences.previewCount", {
                      n: audience._count?.members || 0,
                    })}
                  </span>
                ) : (
                  <span className="text-xs text-[var(--crm-text-muted)]">
                    {t("audiences.nContacts", {
                      n: audience._count?.members || 0,
                    })}
                  </span>
                )}
