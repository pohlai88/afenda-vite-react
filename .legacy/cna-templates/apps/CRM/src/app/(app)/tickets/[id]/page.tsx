    ...
    <div className="flex flex-col lg:flex-row gap-3 p-6 min-h-0">
      ...
      <div className="flex-1 min-w-0 space-y-4">
        ...
        <div>
          ...
          <div className="flex items-center gap-3 mt-1.5">
            <span className="text-xs font-mono text-[var(--crm-text-muted)]">
              {ticket.ticketNumber}
            </span>
            <Badge
                ...
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <span className="text-xs text-[var(--crm-text-muted)] ml-2">
                      {isStaff
                        ? t("tickets.staffLabel" as any)
                        : t("tickets.customerLabel" as any)}
                    </span>
                  </div>
                  {isNote && (
        ...
        <div className="glass-card-static overflow-hidden">
          ...
          <div className="p-4">
            <textarea
              ...
              placeholder={
                isInternal
                  ? t("tickets.notePlaceholder" as any)
                  : t("tickets.replyPlaceholder" as any)
              }
              rows={3}
            ...
            <div className="flex items-center justify-between mt-2">
              ...
              >
                ...
                {isInternal
                  ? t("tickets.saveNote" as any)
                  : t("tickets.send" as any)}
              </Button>
            </div>
          </div>
        </div>
      ...
      <div className="w-full lg:w-80 shrink-0 space-y-4">
        ...
        <div className="glass-card-static p-4 space-y-4">
          ...
          {/* Status */}
          <div>
            <label className="text-xs text-[var(--crm-text-muted)] mb-1 block">
          ...
          <div>
            ...
            >
              ...
              <SelectContent className="bg-[var(--crm-bg-hover)] border-[var(--crm-border)]">
                <SelectItem
                  value="NONE"
                  className="text-[var(--crm-text-muted)] focus:bg-[var(--crm-bg-subtle)] focus:text-[var(--crm-text-primary)]"
                >
