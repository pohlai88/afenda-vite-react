    ...
    <Button
      ...
      className={cn(
        ...
        action.variant === "warning" &&
          "border-amber-500/50 hover:bg-amber-500/5",
...
export default function CommandCenterPage() {
    ...
    const newAlerts: Alert[] = [
      {
        ...
        message:
          "AI phát hiện 3 nhân viên có dấu hiệu nghỉ việc trong phòng Kinh doanh",
    ...
    const newRecommendations: AIRecommendation[] = [
      {
        ...
        description:
          "Phân tích cho thấy 3 nhân viên có xác suất nghỉ việc cao (>70%) trong 3 tháng tới. Đề xuất phỏng vấn giữ chân.",
        impact: "high",
        confidence: 87,
      ...
      },
      {
        ...
        description:
          "AI phát hiện có thể tiết kiệm 15% chi phí OT bằng cách tái phân bổ ca làm việc cho nhóm Sản xuất.",
        impact: "medium",
        confidence: 75,
      ...
      },
      {
        ...
        description:
          "8 nhân viên có tiềm năng thăng tiến cao. Đề xuất chương trình đào tạo leadership.",
        impact: "medium",
        confidence: 82,
      ...
      },
      {
        ...
        description:
          "Dự đoán cần tuyển thêm 8-12 nhân viên trong Q1 để đáp ứng mục tiêu tăng trưởng.",
        impact: "low",
        confidence: 68,
      },
    ]
  ...
  const criticalAlerts = alerts.filter(
    (a) => a.type === "critical" && !a.isRead
  )
  const pendingApprovals =
    kpis.find((k) => k.label === "Yêu cầu chờ duyệt")?.value || 0
          ...
          <CardHeader className="pb-2">
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>
                  Số lượng hoạt động theo giờ hôm nay
                </CardDescription>
              </div>
        ...
        <Card>
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
              ...
              <Badge
                variant={
                  criticalAlerts.length > 0 ? "destructive" : "secondary"
                }
              >
