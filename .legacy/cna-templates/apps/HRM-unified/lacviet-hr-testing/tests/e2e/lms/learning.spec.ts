...
test.describe("LMS - Course Player", () => {
  ...
  test("should take quiz", async ({ page }) => {
    ...
    // Find quiz lesson
    const quizLesson = page.locator(
      '[data-testid="lesson-item"][data-type="quiz"]'
    )
...
test.describe("LMS - Certifications", () => {
  ...
  test("should download certificate", async ({ page }) => {
    const downloadButton = page
      .locator('[data-testid="download-certificate"]')
      .first()
  ...
  test("should view certificate details", async ({ page }) => {
    ...
    if (await certItem.isVisible()) {
      ...
      await expect(
        page.locator('[data-testid="cert-course-name"]')
      ).toBeVisible()
      await expect(
        page.locator('[data-testid="cert-completion-date"]')
      ).toBeVisible()
      await expect(
        page.locator('[data-testid="cert-credential-id"]')
      ).toBeVisible()
    }
  })
})
