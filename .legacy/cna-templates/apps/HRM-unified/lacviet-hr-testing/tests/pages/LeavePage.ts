...
export class LeavePage extends BasePage {
  ...
  constructor(page: Page) {
    ...
    // List page
    this.createRequestButton = page.locator(
      '[data-testid="create-leave-request"]'
    )
  ...
  async getLeaveBalance(
    ...
    const used = await balanceCard
      .locator('[data-testid="balance-used"]')
      .textContent()
    const remaining = await balanceCard
      .locator('[data-testid="balance-remaining"]')
      .textContent()
    const total = await balanceCard
      .locator('[data-testid="balance-total"]')
      .textContent()
  ...
  async expectRequestStatus(requestId: string, status: string): Promise<void> {
    ...
    await expect(row.locator('[data-testid="status-badge"]')).toContainText(
      status
    )
  }
