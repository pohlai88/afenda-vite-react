  ...
  private initializeFunctions(): void {
      ...
      examples: [
        {
          ...
          description: "Average of A1 to A10",
          result: null,
        },
      ],
      nlPatterns: [
      ...
      examples: [
        {
          ...
          description: "Count numbers in A1 to A10",
          result: null,
        },
      ],
      nlPatterns: [
    ...
    this.addFunction({
      ...
      examples: [
        {
          formula: "=MAX(A1:A10)",
          description: "Maximum in A1 to A10",
          result: null,
        },
      ],
      nlPatterns: [
    ...
    this.addFunction({
      ...
      examples: [
        {
          formula: "=MIN(A1:A10)",
          description: "Minimum in A1 to A10",
          result: null,
        },
      ],
      nlPatterns: [
    ...
    this.addFunction({
      ...
      category: "lookup",
      description:
        "Looks up value in leftmost column and returns value in same row",
    ...
    this.addFunction({
      ...
      examples: [
        {
          formula: "=YEAR(A1)",
          description: "Year of date in A1",
          result: null,
        },
      ],
      nlPatterns: [],
    ...
    this.addFunction({
      ...
      examples: [
        {
          formula: "=MONTH(A1)",
          description: "Month of date in A1",
          result: null,
        },
      ],
      nlPatterns: [],
    ...
    this.addFunction({
      ...
      descriptionVi:
        "Tìm kiếm trong phạm vi và trả về giá trị tương ứng với kết quả đầu tiên",
      syntax:
      ...
      parameters: [
        ...
        },
        {
          ...
          type: "any",
          required: false,
          description: "Value if not found",
        },
        {
          name: "match_mode",
          type: "number",
          required: false,
          description:
            "0=exact, -1=exact or smaller, 1=exact or larger, 2=wildcard",
        },
        {
          name: "search_mode",
          type: "number",
    ...
    this.addFunction({
      ...
      parameters: [
        ...
        },
        {
          ...
          type: "any",
          required: false,
          description: "Value if no results",
        },
      ],
      returnType: "array",
      examples: [
        {
          formula: "=FILTER(A:B,A:A>100)",
          description: "Filter rows where A > 100",
          result: null,
        },
      ],
      nlPatterns: [
    ...
    this.addFunction({
      ...
      examples: [
        {
          formula: "=UNIQUE(A:A)",
          description: "Unique values in column A",
          result: null,
        },
      ],
      nlPatterns: [
    ...
    this.addFunction({
      ...
      examples: [
        {
          formula: "=SORTBY(A:B,B:B,-1)",
          description: "Sort A:B by B descending",
          result: null,
        },
      ],
      nlPatterns: [],
    ...
    this.addFunction({
      ...
      category: "statistical",
      description:
        "Returns maximum value among cells specified by given criteria",
      ...
      examples: [
        {
          formula: '=MAXIFS(C:C,A:A,"North")',
          description: "Max C where A=North",
          result: null,
        },
      ],
      nlPatterns: [],
    ...
    this.addFunction({
      ...
      category: "statistical",
      description:
        "Returns minimum value among cells specified by given criteria",
      ...
      examples: [
        {
          formula: '=MINIFS(C:C,A:A,"North")',
          description: "Min C where A=North",
          result: null,
        },
      ],
      nlPatterns: [],
    ...
    this.addFunction({
      ...
      descriptionVi:
        "Đánh giá biểu thức với danh sách giá trị và trả về kết quả tương ứng",
      syntax:
      ...
      parameters: [
        ...
        },
        {
          ...
          type: "any",
          required: true,
          description: "Result if value1 matches",
        },
        {
          name: "default",
          type: "any",
    ...
    this.addFunction({
      ...
      examples: [
        {
          formula: "=XOR(A1>10,B1>20)",
          description: "XOR of two conditions",
          result: null,
        },
      ],
      nlPatterns: [],
    ...
    this.addFunction({
      ...
      examples: [
        {
          formula: "=POWER(2,8)",
          description: "2 to the power of 8",
          result: 256,
        },
      ],
      nlPatterns: [
      ...
      examples: [
        {
          ...
          description: "Round up to 2 decimals",
          result: 3.15,
        },
      ],
      nlPatterns: [],
      ...
      examples: [
        {
          ...
          description: "Product of A1 to A5",
          result: null,
        },
      ],
      nlPatterns: [
      ...
      examples: [
        {
          ...
          description: "Sum of A*B products",
          result: null,
        },
      ],
      nlPatterns: [
    ...
    this.addFunction({
      ...
      examples: [
        {
          formula: "=TRIM(A1)",
          description: "Trim spaces from A1",
          result: null,
        },
      ],
      nlPatterns: [
    ...
    this.addFunction({
      ...
      examples: [
        {
          formula: "=MID(A1,2,3)",
          description: "3 chars starting at position 2",
          result: null,
        },
      ],
      nlPatterns: [],
    ...
    this.addFunction({
      ...
      examples: [
        {
          formula: "=LEN(A1)",
          description: "Length of text in A1",
          result: null,
        },
      ],
      nlPatterns: [
    ...
    this.addFunction({
      ...
      descriptionVi:
        "Tìm chuỗi văn bản trong chuỗi khác (phân biệt hoa thường)",
      ...
      examples: [
        {
          formula: '=FIND("a",A1)',
          description: 'Position of "a" in A1',
          result: null,
        },
      ],
      nlPatterns: [
    ...
    this.addFunction({
      ...
      parameters: [
        ...
        },
        {
          ...
          type: "text|range",
          required: true,
          description: "First text or range",
        },
      ],
      returnType: "text",
      examples: [
      ...
      examples: [
        {
          ...
          description: "Days between A1 and B1",
          result: null,
        },
      ],
      nlPatterns: [
    ...
    this.addFunction({
      ...
      examples: [
        {
          formula: "=EDATE(A1,3)",
          description: "Add 3 months to A1",
          result: null,
        },
      ],
      nlPatterns: [
    ...
    this.addFunction({
      ...
      examples: [
        {
          formula: "=WEEKDAY(A1)",
          description: "Day of week for A1",
          result: null,
        },
      ],
      nlPatterns: [
    ...
    this.addFunction({
      ...
      examples: [
        {
          formula: "=WEEKNUM(A1)",
          description: "Week number for A1",
          result: null,
        },
      ],
      nlPatterns: [
        {
          pattern: "week number of (.+)",
          language: "en",
          priority: 1,
          transform: "WEEKNUM($1)",
        },
        {
          pattern: "tuần thứ mấy (.+)",
          language: "vi",
          priority: 1,
          transform: "WEEKNUM($1)",
        },
    ...
    this.addFunction({
      ...
      parameters: [
        ...
        },
        {
          ...
          type: "range",
          required: false,
          description: "Range of holiday dates",
        },
      ],
      returnType: "number",
      examples: [
        {
          ...
          description: "Workdays between A1 and B1",
          result: null,
        },
      ],
      nlPatterns: [
    ...
    this.addFunction({
      ...
      category: "date",
      description:
        "Returns a date that is a specified number of workdays from a date",
      ...
      examples: [
        {
          ...
          description: "Add 10 workdays to A1",
          result: null,
        },
      ],
      nlPatterns: [
    ...
    this.addFunction({
      ...
      examples: [
        {
          formula: "=HOUR(A1)",
          description: "Hour of time in A1",
          result: null,
        },
      ],
      nlPatterns: [],
    ...
    this.addFunction({
      ...
      examples: [
        {
          formula: "=MINUTE(A1)",
          description: "Minute of time in A1",
          result: null,
        },
      ],
      nlPatterns: [],
    ...
    this.addFunction({
      ...
      examples: [
        {
          formula: "=SECOND(A1)",
          description: "Second of time in A1",
          result: null,
        },
      ],
      nlPatterns: [],
      ...
      examples: [
        {
          ...
          description: "Standard deviation of A1:A10",
          result: null,
        },
      ],
      nlPatterns: [
    ...
    this.addFunction({
      ...
      examples: [
        {
          formula: "=VAR(A1:A10)",
          description: "Variance of A1:A10",
          result: null,
        },
      ],
      nlPatterns: [
    ...
    this.addFunction({
      ...
      examples: [
        {
          formula: "=RANK(A1,A:A)",
          description: "Rank of A1 in column A",
          result: null,
        },
      ],
      nlPatterns: [
    ...
    this.addFunction({
      ...
      parameters: [
        ...
        },
        {
          ...
          type: "number",
          required: true,
          description: "Position from largest",
        },
      ],
      returnType: "number",
      examples: [
    ...
    this.addFunction({
      ...
      parameters: [
        ...
        },
        {
          ...
          type: "number",
          required: true,
          description: "Position from smallest",
        },
      ],
      returnType: "number",
      examples: [
        {
          ...
          description: "Second smallest value",
          result: null,
        },
      ],
      nlPatterns: [
    ...
    this.addFunction({
      ...
      nlPatterns: [
        {
          pattern:
            "monthly payment for (.+) at (.+)% for (\\d+) (?:months|years)",
          language: "en",
          priority: 1,
        ...
        {
          pattern:
            "thanh toán hàng tháng cho (.+) với lãi (.+)% trong (\\d+) tháng",
          language: "vi",
          priority: 1,
          transform: "PMT($2/100/12,$3,$1)",
        },
      ...
      parameters: [
        {
          ...
          type: "range",
          required: true,
          description: "Range of cash flows",
        },
        {
          name: "guess",
          type: "number",
    ...
    this.addFunction({
      ...
      examples: [
        {
          formula: "=ISBLANK(A1)",
          description: "Check if A1 is empty",
          result: null,
        },
      ],
      nlPatterns: [
    ...
    this.addFunction({
      ...
      examples: [
        {
          formula: "=ISNUMBER(A1)",
          description: "Check if A1 is a number",
          result: null,
        },
      ],
      nlPatterns: [
    ...
    this.addFunction({
      ...
      examples: [
        {
          formula: "=ISTEXT(A1)",
          description: "Check if A1 is text",
          result: null,
        },
      ],
      nlPatterns: [
    ...
    this.addFunction({
      ...
      examples: [
        {
          formula: "=ISERROR(A1)",
          description: "Check if A1 has an error",
          result: null,
        },
      ],
      nlPatterns: [],
    ...
    this.addFunction({
      ...
      examples: [
        {
          formula: "=TYPE(A1)",
          description: "Type of value in A1",
          result: null,
        },
      ],
      nlPatterns: [],
      ...
      parameters: [
        {
          ...
          type: "text",
          required: true,
          description: "Reference as text",
        },
        {
          name: "a1",
          type: "boolean",
          required: false,
          description: "TRUE for A1 style",
        },
      ],
      returnType: "any",
      examples: [
    ...
    this.addFunction({
      ...
      parameters: [
        ...
        },
        {
          ...
          type: "number",
          required: true,
          description: "Rows to offset",
        },
        {
          name: "cols",
          type: "number",
          required: true,
          description: "Columns to offset",
        },
        {
          name: "height",
          type: "number",
          required: false,
          description: "Height of result",
        },
        {
          name: "width",
          type: "number",
          required: false,
          description: "Width of result",
        },
      ],
      returnType: "range",
      examples: [
        {
          ...
          description: "Cell 2 rows down, 3 cols right",
          result: null,
        },
      ],
      nlPatterns: [],
      ...
      parameters: [
        {
          ...
          type: "range",
          required: true,
          description: "Range to count rows",
        },
      ],
      returnType: "number",
      examples: [
        {
          formula: "=ROWS(A1:A10)",
          description: "Number of rows in A1:A10",
          result: 10,
        },
      ],
      nlPatterns: [],
      ...
      parameters: [
        {
          ...
          type: "range",
          required: true,
          description: "Range to count columns",
        },
      ],
      returnType: "number",
      examples: [
        {
          ...
          description: "Number of columns in A1:E1",
          result: 5,
        },
      ],
      nlPatterns: [],
