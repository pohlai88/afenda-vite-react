...
describe("Logical Functions", () => {
  ...
  describe("IFERROR", () => {
    ...
    it("should handle nested IFERROR", () => {
      expect(calc('=IFERROR(IFERROR(1/0,2/0),"double error")').value).toBe(
        "double error"
      )
    })
  })
  ...
  describe("IFS", () => {
    ...
    it("should handle default case with TRUE", () => {
      expect(calc('=IFS(FALSE,"A",FALSE,"B",TRUE,"default")').value).toBe(
        "default"
      )
    })
  })
  ...
  describe("SWITCH", () => {
    ...
    it("should handle string expression", () => {
      expect(
        calc('=SWITCH("B","A","alpha","B","beta","C","gamma")').value
      ).toBe("beta")
    })
