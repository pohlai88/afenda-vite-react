  ...
  devtools(
    (set, get) => ({
      ...
      deleteChart: (chartId) => {
        set((state) => {
          ...
          return {
            ...
            chartData,
            selectedChartId:
              state.selectedChartId === chartId ? null : state.selectedChartId,
            editingChartId:
              state.editingChartId === chartId ? null : state.editingChartId,
          }
        })
      },
        ...
        set((state) => {
          ...
          if (chart) {
            ...
            const newSeries = {
              ...
              color:
                series.color ||
                DEFAULT_CHART_COLORS[colorIndex % DEFAULT_CHART_COLORS.length],
            }
            charts.set(chartId, {
              ...chart,
      ...
      getChartsByWorkbook: (workbookId) => {
        const { charts } = get()
        return Array.from(charts.values()).filter(
