...
export const selectBackendAvailable = (state: SyncState) =>
  state.backendAvailable
export const selectGlobalPendingCount = (state: SyncState) =>
  state.globalPendingCount
export const selectActiveConflicts = (state: SyncState) => state.activeConflicts
export const selectHasConflicts = (state: SyncState) =>
