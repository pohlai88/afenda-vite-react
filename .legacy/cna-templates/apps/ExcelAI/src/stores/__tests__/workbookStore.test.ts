...
describe("workbookStore", () => {
    ...
    it("should handle large batch updates", () => {
      ...
      for (let i = 0; i < 1000; i++) {
        updates.push({
          row: i,
          col: 0,
          data: { value: i, displayValue: String(i) },
        })
      }
  ...
  describe("clearCell", () => {
    it("should remove cell data", () => {
      ...
      expect(
        useWorkbookStore.getState().sheets["sheet-1"].cells["0:0"]
      ).toBeUndefined()
    })
  ...
  describe("renameSheet", () => {
    it("should rename a sheet", () => {
      ...
      expect(useWorkbookStore.getState().sheets["sheet-1"].name).toBe(
        "Renamed Sheet"
      )
    })
  ...
  describe("setTabColor", () => {
    it("should set tab color", () => {
      ...
      expect(useWorkbookStore.getState().sheets["sheet-1"].tabColor).toBe(
        "#ff0000"
      )
    })
  })
  ...
  describe("insertRow", () => {
    ...
    it("should use selected cell row if no index provided", () => {
      ...
      expect(
        useWorkbookStore.getState().sheets["sheet-1"].cells["6:0"]?.value
      ).toBe("Row 5")
    })
  })
  ...
  describe("paste", () => {
    it("should paste clipboard contents", () => {
      ...
      expect(
        useWorkbookStore.getState().sheets["sheet-1"].cells["2:2"]?.value
      ).toBe("A1")
    })
  ...
  describe("history", () => {
    ...
    it("should redo changes", () => {
      ...
      expect(
        useWorkbookStore.getState().sheets["sheet-1"].cells["0:0"]?.value
      ).toBe("test")
    })
  ...
  describe("applyFormat", () => {
    it("should apply format to selection", () => {
      ...
      expect(
        useWorkbookStore.getState().sheets["sheet-1"].cells["0:0"]?.format?.bold
      ).toBe(true)
    })
  ...
  describe("clearFormat", () => {
    it("should clear formatting", () => {
      ...
      expect(
        useWorkbookStore.getState().sheets["sheet-1"].cells["0:0"]?.format
      ).toBeUndefined()
    })
  })
  ...
  describe("hideRow", () => {
    it("should hide a row", () => {
      ...
      expect(
        useWorkbookStore.getState().sheets["sheet-1"].hiddenRows?.has(5)
      ).toBe(true)
    })
  })
  ...
  describe("hideColumn", () => {
    it("should hide a column", () => {
      ...
      expect(
        useWorkbookStore.getState().sheets["sheet-1"].hiddenColumns?.has(3)
      ).toBe(true)
    })
  })
  ...
  describe("hideSheet", () => {
    ...
    it("should not hide last visible sheet", () => {
      ...
      expect(
        useWorkbookStore.getState().sheets["sheet-1"].hidden
      ).toBeUndefined()
    })
  })
  ...
  describe("setFreezePane", () => {
    it("should set freeze pane", () => {
      ...
      expect(useWorkbookStore.getState().sheets["sheet-1"].freezePane).toEqual({
        row: 2,
        col: 3,
      })
    })
  ...
  describe("clearFreezePane", () => {
    it("should clear freeze pane", () => {
      ...
      expect(
        useWorkbookStore.getState().sheets["sheet-1"].freezePane
      ).toBeUndefined()
    })
  })
  ...
  describe("setRowHeight", () => {
    it("should set row height", () => {
      ...
      expect(
        useWorkbookStore.getState().sheets["sheet-1"].rowHeights?.[5]
      ).toBe(50)
    })
  ...
  describe("setColumnWidth", () => {
    it("should set column width", () => {
      ...
      expect(
        useWorkbookStore.getState().sheets["sheet-1"].columnWidths?.[3]
      ).toBe(200)
    })
