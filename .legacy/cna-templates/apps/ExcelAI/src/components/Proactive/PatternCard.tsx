      ...
      <div className="pattern-card__content">
        ...
        {metadata?.sequence && (
          <div className="pattern-card__sequence">
            <div className="pattern-card__sequence-label">
              Detected Pattern:
            </div>
              ...
              {metadata.sequence.map((step, index) => (
                <React.Fragment key={index}>
                  <div className="pattern-card__step">
                    <span className="pattern-card__step-icon">
                      {getActionIcon(step.action)}
                    </span>
                    <span className="pattern-card__step-label">
                      {step.action}
                    </span>
                  </div>
        ...
        {metadata?.suggestedAutomation && (
          <div className="pattern-card__automation">
            <div className="pattern-card__automation-label">
              Suggested Automation:
            </div>
