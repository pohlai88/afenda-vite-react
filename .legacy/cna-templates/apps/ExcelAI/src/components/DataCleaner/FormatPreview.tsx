...
const FormatTypeCard: React.FC<FormatTypeCardProps> = ({
  ...
  return (
    <div
      className={`format-type-card ${isSelected ? "format-type-card--selected" : ""}`}
    >
      {/* Card Header */}
      <div className="format-type-card__header">
        ...
        <div
          className="format-type-card__icon"
        ...
        <div className="format-type-card__info" onClick={onToggleExpand}>
          ...
          <span className="format-type-card__count">
        ...
        <div className="format-type-card__examples">
          ...
          {summary.examples.map((example, i) => (
            <div key={i} className="format-type-card__example">
              ...
              <span className="format-type-card__original">
                {example.originalValue}
              </span>
              <span className="format-type-card__arrow">→</span>
              <span className="format-type-card__standardized">
                {example.standardizedValue}
              </span>
              {onReject && (
                <button
        ...
        <div className="format-settings">
          <label className="format-settings__label">
            ...
            <select
              ...
              onChange={(e) =>
                onChange({ ...settings, targetFormat: e.target.value })
              }
        ...
        <div className="format-settings">
          <label className="format-settings__label">
            ...
            <select
              ...
              onChange={(e) =>
                onChange({ ...settings, phoneFormat: e.target.value })
              }
              className="format-settings__select"
            >
        ...
        <div className="format-settings">
          <label className="format-settings__label">
            ...
            <select
              ...
              onChange={(e) =>
                onChange({ ...settings, nameCase: e.target.value })
              }
              className="format-settings__select"
            >
