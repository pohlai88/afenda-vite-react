...
describe("CellRenderer", () => {
  ...
  describe("selection styling", () => {
    ...
    it("does not apply selected style when editing", () => {
      render(
        <CellRenderer {...defaultProps} isSelected={true} isEditing={true} />
      )
  ...
  describe("tooltip", () => {
    it("shows formula in tooltip", () => {
      ...
      expect(cell).toHaveAttribute(
        "title",
        expect.stringContaining("Formula: =SUM(A1:A10)")
      )
    })
    ...
    it("shows error in tooltip", () => {
      ...
      expect(cell).toHaveAttribute(
        "title",
        expect.stringContaining("Error: #DIV/0!")
      )
    })
  })
