...
> = ({ onClose }) => {
  ...
  const getColors = () => {
    ...
    return {
      bg: PRESET_COLORS[selectedPreset].bg,
      text: PRESET_COLORS[selectedPreset].text,
    }
  }
  ...
  const needsValue1 = !["duplicate", "top10", "blank", "notBlank"].includes(
    ruleType
  )
          ...
          {needsValue1 && (
            <div className="dialog-field">
              ...
              <input
                ...
                placeholder={
                  ruleType === "textContains" ? "Enter text" : "Enter value"
                }
                className="dialog-input"
              />
            </div>
