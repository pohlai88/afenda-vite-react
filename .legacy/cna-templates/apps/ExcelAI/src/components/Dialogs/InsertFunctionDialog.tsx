...
const ALL_FUNCTIONS = [
  ...
  },
  {
    ...
    category: "Math",
    syntax: "RAND()",
    desc: "Returns random number 0-1",
  },
  {
    name: "RANDBETWEEN",
    category: "Math",
  ...
  },
  {
    ...
    category: "Text",
    syntax: "PROPER(text)",
    desc: "Capitalizes each word",
  },
  {
    name: "TRIM",
    category: "Text",
    syntax: "TRIM(text)",
    desc: "Removes extra spaces",
  },
  {
    name: "SUBSTITUTE",
    category: "Text",
