...
import {
  convertVBALocally,
  ConvertedMacro,
} from "../../ai/tools/vbaConverterTool"
...
export const VBAImportDialog: React.FC<VBAImportDialogProps> = ({
  isOpen,
  onClose,
  onImport,
}) => {
          ...
          <>
            ...
            <div className="px-4 py-3 flex-1 overflow-y-auto">
              <p className="text-sm text-neutral-600 dark:text-neutral-400 mb-3">
                Paste your VBA macro code below. ExcelAI will convert it to
                native macro actions.
              </p>
              <textarea
                value={vbaCode}
