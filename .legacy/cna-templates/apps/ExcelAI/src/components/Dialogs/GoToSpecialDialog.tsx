...
export const GoToSpecialDialog: React.FC<GoToSpecialDialogProps> = ({
  onClose,
}) => {
        ...
        switch (selectedType) {
          ...
          case "constants":
            if (
              ...
              if (constantOptions.numbers && typeof value === "number")
                matches = true
              if (
                constantOptions.text &&
                typeof value === "string" &&
                isNaN(Number(value))
              )
                matches = true
              if (constantOptions.logicals && typeof value === "boolean")
                matches = true
              if (
                constantOptions.errors &&
                typeof value === "string" &&
                value.startsWith("#")
              )
                matches = true
          ...
          case "formulas":
            if (cell?.formula && cell.formula.startsWith("=")) {
              const value = cell.value
              if (formulaOptions.numbers && typeof value === "number")
                matches = true
              if (
                formulaOptions.text &&
                typeof value === "string" &&
                ...
                matches = true
              if (formulaOptions.logicals && typeof value === "boolean")
                matches = true
              if (
          ...
          case "dataValidation":
            ...
            matches = !!(
              ...
              useValidationStore
                .getState()
                .getRuleForCell(activeSheetId, row, col)
            )
            break
  ...
  const specialTypes: {
    ...
    { id: "comments", label: "Comments", description: "Cells with comments" },
    {
      id: "constants",
      label: "Constants",
      description: "Cells with constant values",
    },
    {
      id: "formulas",
      label: "Formulas",
      description: "Cells containing formulas",
    },
    { id: "blanks", label: "Blanks", description: "Empty cells" },
    {
      id: "lastCell",
      label: "Last cell",
      description: "Last used cell in sheet",
    },
    {
      id: "visibleCellsOnly",
      label: "Visible cells only",
      description: "Only visible cells",
    },
    {
    ...
    },
    {
      ...
      description: "Cells with validation rules",
    },
  ]
    ...
    <div className="dialog-overlay" onClick={onClose}>
      ...
      >
        ...
        <div className="dialog-body">
            ...
            {specialTypes.map((type) => (
              <label key={type.id} className="goto-special-option">
                ...
                <div className="goto-special-option-content">
                  <span className="goto-special-option-label">
                    {type.label}
                  </span>
                  <span className="goto-special-option-desc">
                    {type.description}
                  </span>
                </div>
              </label>
          ...
          {showFormulaOptions && (
            <div className="goto-special-suboptions">
              <div className="goto-special-suboptions-title">
                Formula results:
              </div>
              <div className="goto-special-checkboxes">
                <label>
