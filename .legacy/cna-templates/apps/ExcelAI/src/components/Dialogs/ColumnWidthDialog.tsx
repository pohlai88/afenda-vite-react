...
export const ColumnWidthDialog: React.FC<ColumnWidthDialogProps> = ({
  onClose,
}) => {
      ...
      >
        ...
        <div className="dialog-body">
          ...
          <div className="dialog-preset-buttons">
            <button className="dialog-preset-btn" onClick={() => setWidth(50)}>
              Narrow (50)
            </button>
            <button className="dialog-preset-btn" onClick={() => setWidth(100)}>
              Default (100)
            </button>
            <button className="dialog-preset-btn" onClick={() => setWidth(150)}>
              Wide (150)
            </button>
            <button className="dialog-preset-btn" onClick={() => setWidth(250)}>
              Extra Wide (250)
            </button>
          </div>
        </div>
