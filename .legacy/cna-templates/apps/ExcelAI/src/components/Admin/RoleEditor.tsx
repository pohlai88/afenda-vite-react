  ...
  workbooks: {
    ...
    permissions: [
      { id: "workbooks:read", name: "View", description: "View workbooks" },
      {
        id: "workbooks:create",
        name: "Create",
        description: "Create new workbooks",
      },
      { id: "workbooks:update", name: "Edit", description: "Edit workbooks" },
      {
        id: "workbooks:delete",
        name: "Delete",
        description: "Delete workbooks",
      },
      {
        id: "workbooks:share",
        name: "Share",
        description: "Share workbooks with others",
      },
      {
        id: "workbooks:export",
        name: "Export",
        description: "Export workbooks",
      },
    ],
  },
  sheets: {
...
export const RoleEditor: React.FC = () => {
  ...
  const toggleCategoryPermissions = (category: string) => {
    ...
    if (allSelected) {
      newPermissions = selectedRole.permissions.filter(
                  ...
                  {Object.entries(PERMISSION_CATEGORIES).map(
                    ([categoryKey, category]) => {
                      const { selected, total } =
                        getCategoryPermissionCount(categoryKey)
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                setFormData({ ...formData, copyFrom: e.target.value })
              }
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
            >
