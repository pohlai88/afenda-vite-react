  ...
  return (
    ...
    >
      ...
      <SubMenu label="Insert" icon={<PlusIcon />}>
        <MenuItem
          label="Insert cells..."
          onClick={() => handleAction("INSERT_CELLS")}
        />
        <MenuItem
          label="Insert row above"
          onClick={() => handleAction("INSERT_ROW_ABOVE")}
        />
        <MenuItem
          label="Insert row below"
          onClick={() => handleAction("INSERT_ROW_BELOW")}
        />
        <MenuItem
          label="Insert column left"
          onClick={() => handleAction("INSERT_COL_LEFT")}
        />
        <MenuItem
          label="Insert column right"
          onClick={() => handleAction("INSERT_COL_RIGHT")}
        />
      </SubMenu>
