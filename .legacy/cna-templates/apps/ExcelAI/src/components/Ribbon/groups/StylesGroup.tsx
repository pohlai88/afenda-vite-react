...
export const StylesGroup: React.FC = () => {
  ...
  const applyStyle = (
    styleName: string,
    format: Parameters<typeof applyFormat>[0]
  ) => {
    applyFormat(format)
          ...
          options={[
            {
              ...
              label: "Light",
              onClick: () =>
                applyStyle("Light Table", { backgroundColor: "#f5f5f5" }),
            },
            {
              id: "medium",
              label: "Medium",
              onClick: () =>
                applyStyle("Medium Table", { backgroundColor: "#e3f2fd" }),
            },
            {
              id: "dark",
              label: "Dark",
              onClick: () =>
                applyStyle("Dark Table", {
