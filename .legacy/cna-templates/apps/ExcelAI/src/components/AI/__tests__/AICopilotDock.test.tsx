...
vi.mock("../ActionsPanel", () => ({
  ActionsPanel: () => (
    <div data-testid="actions-panel">Actions Panel Content</div>
  ),
}))

vi.mock("../ContextPanel", () => ({
  ContextPanel: () => (
    <div data-testid="context-panel">Context Panel Content</div>
  ),
}))

vi.mock("../HistoryPanel", () => ({
  HistoryPanel: () => (
    <div data-testid="history-panel">History Panel Content</div>
  ),
}))
