    ...
    () => [
      ...
      // === Format ===
      {
        ...
        action: () => {
          ...
          if (cell && workbook.activeSheetId) {
            const current =
              workbook.sheets[workbook.activeSheetId]?.cells[
      ...
      },
      {
        ...
        action: () => {
          ...
          ui.showToast(
            workbook.filterEnabled ? "Filter enabled" : "Filter disabled",
            "info"
          )
        },
      },
      ...
      },
      {
        ...
        description: workbook.showGridlines
          ? "Hide gridlines"
          : "Show gridlines",
        icon: Grid,
        group: "View",
      ...
      },
      {
        ...
        description: ui.formulaBarVisible
          ? "Hide formula bar"
          : "Show formula bar",
        icon: Calculator,
        group: "View",
                ...
                return (
                  ...
                  >
                    ...
                    <div className="cmd-palette__item-content">
                      ...
                      {cmd.description && (
                        <div className="cmd-palette__item-desc">
                          {cmd.description}
                        </div>
                      )}
                    </div>
