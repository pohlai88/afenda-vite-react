...
export const StatusBar2026Enhanced: React.FC = () => {
  ...
  useEffect(() => {
    const handleClickOutside = (e: MouseEvent) => {
      if (
        calcMenuRef.current &&
        !calcMenuRef.current.contains(e.target as Node)
      ) {
        setShowCalcMenu(false)
      }
      if (
        zoomSliderRef.current &&
        !zoomSliderRef.current.contains(e.target as Node)
      ) {
      ...
      <div className="status-bar-enhanced__left">
        ...
        {cellInfo && (
          <div className="status-bar-enhanced__cell-info">
            <span className="status-bar-enhanced__cell-address">
              {cellInfo}
            </span>
          </div>
        )}
        ...
        {stats && (
          <div className="status-bar-enhanced__stats">
            {calcOptions
              ...
              .map((opt) => {
                ...
                return (
                  ...
                  >
                    <span className="status-bar-enhanced__stat-label">
                      {opt.label}:
                    </span>
            ...
            <div
              className="status-bar-enhanced__calc-customize"
              ref={calcMenuRef}
            >
              <button
