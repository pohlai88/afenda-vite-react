...
export const IconSetsPreview: React.FC<IconSetsPreviewProps> = ({
  onSelect,
}) => {
  ...
  return (
    <div className="icon-sets-preview">
      {categories.map((category) => {
        const icons = ICON_SET_DEFINITIONS.filter(
      ...
      <div className="preview-footer">
        <button className="more-options-btn">More Icon Sets...</button>
      </div>
    </div>
  )
}
