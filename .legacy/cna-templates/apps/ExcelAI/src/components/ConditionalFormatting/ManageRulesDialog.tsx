...
export const ManageRulesDialog: React.FC<ManageRulesDialogProps> = ({
  ...
  const getRuleDescription = (rule: CFRule): string => {
    switch (rule.type) {
      ...
      case "duplicate":
        return rule.duplicateType === "unique"
          ? "Unique values"
          : "Duplicate values"
        ...
        <div className="dialog-body">
          ...
          <div className="rules-toolbar">
            ...
            <div className="toolbar-right">
              <button className="toolbar-btn primary" onClick={onAddRule}>
                <Plus size={14} />
                New Rule
              </button>
            </div>
                  ...
                  {rules.map((rule, index) => (
                    ...
                    >
                      ...
                      <td className="stop-cell">
                        {rule.stopIfTrue && (
                          <span className="stop-badge">Yes</span>
                        )}
                      </td>
                    </tr>
                  ))}
            ...
            <div className="rules-actions">
              <div className="action-group">
                <button
                  ...
                  onClick={() =>
                    selectedRuleId &&
                    movePriority(selectedRuleId, "up", sheetId)
                  }
                  title="Move Up"
                >
                  <ChevronUp size={16} />
                ...
                <button
                  ...
                  onClick={() =>
                    selectedRuleId &&
                    movePriority(selectedRuleId, "down", sheetId)
                  }
                  title="Move Down"
                >
                  <ChevronDown size={16} />
              ...
              <div className="action-group">
                <button
                  ...
                  disabled={!selectedRuleId}
                  onClick={() =>
                    selectedRuleId && toggleRule(selectedRuleId, sheetId)
                  }
                  title="Enable/Disable"
                >
                  {rules.find((r) => r.id === selectedRuleId)?.enabled !==
                  false ? (
                    <EyeOff size={16} />
                  ) : (
                    <Eye size={16} />
