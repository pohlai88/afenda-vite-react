...
export const CalculatedFieldDialog: React.FC<CalculatedFieldDialogProps> = ({
  ...
  const { addCalculatedField, updateCalculatedField, removeCalculatedField } =
    usePivotStore()
  ...
  return (
    <div className="pivot-dialog-overlay" onClick={onClose}>
      <div
        className="pivot-dialog calculated-field-dialog"
        ...
        <div className="pivot-dialog-body">
          ...
          <div className="pivot-dialog-section">
            ...
            <div className="formula-input-container">
              ...
              {formula && (
                <div
                  className={`formula-status ${formulaValidation.valid ? "valid" : "invalid"}`}
                >
