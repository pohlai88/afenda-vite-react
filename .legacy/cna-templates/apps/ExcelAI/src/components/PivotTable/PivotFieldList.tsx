...
export const PivotFieldList: React.FC<PivotFieldListProps> = ({
  ...
  const [showCalculatedFieldDialog, setShowCalculatedFieldDialog] =
    useState(false)
  const [editingCalculatedField, setEditingCalculatedField] = useState<
          ...
          <div className="field-dropdown" onClick={(e) => e.stopPropagation()}>
            {area === "value" && (
              <>
                <div className="dropdown-section">
                  ...
                  {(Object.keys(AGGREGATE_LABELS) as AggregateFunction[]).map(
                    (func) => (
                      <button
                        key={func}
                        className={`dropdown-item ${areaField.aggregateFunction === func ? "active" : ""}`}
                        onClick={() =>
                          handleAggregateChange(areaField.fieldId, func)
                        }
                      >
              ...
              <>
                <div className="dropdown-section">
                  ...
                  <button
                    ...
                    onClick={() =>
                      handleSortChange(areaField.fieldId, area, "asc")
                    }
                  >
                    A to Z
                  </button>
                  <button
                    ...
                    onClick={() =>
                      handleSortChange(areaField.fieldId, area, "desc")
                    }
                  >
                    Z to A
                  </button>
                  <button
                    ...
                    onClick={() =>
                      handleSortChange(areaField.fieldId, area, "none")
                    }
                  >
                    No Sort
                  </button>
            ...
            {area === "filter" && (
              <div className="dropdown-section">
                ...
                <button className="dropdown-item">Select values...</button>
              </div>
            )}
          </div>
        )}
