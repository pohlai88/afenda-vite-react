...
describe("useWebSocket", () => {
  ...
  describe("connection", () => {
    ...
    it("sends join message on connection", async () => {
      ...
      await waitFor(() => {
        ...
        const joinMessage = mockWs?.sentMessages.find(
          (m) => JSON.parse(m).type === "join"
        )
  ...
  describe("message sending", () => {
    ...
    it("sends cursor move messages", async () => {
      ...
      const cursorMessage = mockWs?.sentMessages.find(
        (m) => JSON.parse(m).type === "cursor_move"
      )
    ...
    it("sends sheet change messages", async () => {
      ...
      const sheetMessage = mockWs?.sentMessages.find(
        (m) => JSON.parse(m).type === "sheet_change"
      )
