    ...
    (event: MessageEvent) => {
      try {
        ...
        switch (message.type) {
          ...
          case "cursor_move": {
            const cursorPayload = message.payload as CursorMovePayload & {
              userId?: string
            }
          ...
          case "selection_change": {
            const selPayload = message.payload as SelectionChangePayload & {
              userId?: string
            }
          ...
          case "sheet_change": {
            const sheetPayload = message.payload as {
              userId?: string
              sheetId: string
            }
