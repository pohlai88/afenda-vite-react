...
export function createMockCellData(
...
export function createMockCellFormat(
  overrides: Partial<CellFormat> = {}
): CellFormat {
  return {
    bold: false,
    italic: false,
...
export function createMockFormulaResult(
  overrides: Partial<FormulaResult> = {}
): FormulaResult {
  return {
    value: 0,
    displayValue: "0",
...
export function createMockCellDependency(
  overrides: Partial<CellDependency> = {}
): CellDependency {
  return {
    sheetId: "sheet-1",
    row: 0,
...
export function createMockCellReference(
  overrides: Partial<CellReference> = {}
): CellReference {
  return {
    col: 0,
    row: 0,
...
export function createMockSyncMessage(
  overrides: Partial<MockSyncMessage> = {}
): MockSyncMessage {
  return {
    id: nextId("msg"),
...
export function createMockAIMessage(
  overrides: Partial<MockAIMessage> = {}
): MockAIMessage {
  return {
    id: nextId("msg"),
    role: "user",
