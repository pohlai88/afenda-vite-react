...
export const VAS_CHART_OF_ACCOUNTS: VASAccount[] = [
  ...
  },
  {
    accountNumber: "1122",
    name: "Ngoại tệ",
    nameEn: "Foreign currency deposits",
    accountType: "ASSET",
    accountGroup: "GROUP_1",
    normalBalance: "DEBIT",
    level: 2,
  ...
  },
  {
    ...
    nameEn: "Held-to-maturity investments",
    accountType: "ASSET",
    accountGroup: "GROUP_1",
    normalBalance: "DEBIT",
    level: 1,
  ...
  },
  {
    ...
    nameEn: "Input VAT on goods/services",
    accountType: "ASSET",
    accountGroup: "GROUP_1",
    normalBalance: "DEBIT",
    level: 2,
  ...
  },
  {
    ...
    nameEn: "Input VAT on fixed assets",
    accountType: "ASSET",
    accountGroup: "GROUP_1",
    normalBalance: "DEBIT",
    level: 2,
  ...
  },
  {
    ...
    nameEn: "Goods sent on consignment",
    accountType: "ASSET",
    accountGroup: "GROUP_1",
    normalBalance: "DEBIT",
    level: 1,
  ...
  },
  {
    ...
    nameEn: "Other intangible assets",
    accountType: "ASSET",
    accountGroup: "GROUP_2",
    normalBalance: "DEBIT",
    level: 2,
  ...
  },
  {
    ...
    nameEn: "Accum. depr. finance lease",
    accountType: "CONTRA_ASSET",
    accountGroup: "GROUP_2",
    normalBalance: "CREDIT",
    level: 2,
  ...
  {
    accountNumber: "2147",
    name: "Hao mòn BĐS đầu tư",
    nameEn: "Accum. depr. investment property",
    accountType: "CONTRA_ASSET",
    accountGroup: "GROUP_2",
    normalBalance: "CREDIT",
    level: 2,
  ...
  },
  {
    ...
    nameEn: "Investments in JV/associates",
    accountType: "ASSET",
    accountGroup: "GROUP_2",
    normalBalance: "DEBIT",
    level: 1,
...

  {
    ...
    nameEn: "Provision for asset losses",
    accountType: "CONTRA_ASSET",
    accountGroup: "GROUP_2",
    normalBalance: "CREDIT",
    level: 1,
  ...
  },
  {
    ...
    nameEn: "Pledges, mortgages, deposits",
    accountType: "ASSET",
    accountGroup: "GROUP_2",
    normalBalance: "DEBIT",
    level: 1,
  ...
  },
  {
    ...
    nameEn: "Special consumption tax",
    accountType: "LIABILITY",
    accountGroup: "GROUP_3",
    normalBalance: "CREDIT",
    level: 2,
  ...
  {
    accountNumber: "3339",
    name: "Phí, lệ phí và khoản nộp khác",
    nameEn: "Fees and other levies",
    accountType: "LIABILITY",
    accountGroup: "GROUP_3",
    normalBalance: "CREDIT",
    level: 2,
  ...
  {
    accountNumber: "337",
    name: "Thanh toán theo tiến độ kế hoạch HĐXD",
    nameEn: "Construction contract progress billings",
    accountType: "LIABILITY",
    accountGroup: "GROUP_3",
    normalBalance: "CREDIT",
    level: 1,
  ...
  },
  {
    ...
    nameEn: "Surplus assets pending resolution",
    accountType: "LIABILITY",
    accountGroup: "GROUP_3",
    normalBalance: "CREDIT",
    level: 2,
...

  {
    ...
    nameEn: "Borrowings and finance leases",
    accountType: "LIABILITY",
    accountGroup: "GROUP_3",
    normalBalance: "CREDIT",
    level: 1,
  ...
  },
  {
    ...
    nameEn: "Finance lease liabilities",
    accountType: "LIABILITY",
    accountGroup: "GROUP_3",
    normalBalance: "CREDIT",
    level: 2,
  ...
  },
  {
    ...
    nameEn: "Convertible bond options",
    accountType: "EQUITY",
    accountGroup: "GROUP_4",
    normalBalance: "CREDIT",
    level: 2,
  ...
  },
  {
    ...
    nameEn: "Development investment fund",
    accountType: "EQUITY",
    accountGroup: "GROUP_4",
    normalBalance: "CREDIT",
    level: 1,
  ...
  {
    accountNumber: "417",
    name: "Quỹ dự phòng tài chính",
    nameEn: "Financial reserve fund",
    accountType: "EQUITY",
    accountGroup: "GROUP_4",
    normalBalance: "CREDIT",
    level: 1,
  ...
  },
  {
    ...
    nameEn: "Prior year retained earnings",
    accountType: "EQUITY",
    accountGroup: "GROUP_4",
    normalBalance: "CREDIT",
    level: 2,
  ...
  },
  {
    ...
    nameEn: "Current year retained earnings",
    accountType: "EQUITY",
    accountGroup: "GROUP_4",
    normalBalance: "CREDIT",
    level: 2,
  ...
  {
    accountNumber: "5117",
    name: "Doanh thu kinh doanh bất động sản",
    nameEn: "Real estate revenue",
    accountType: "REVENUE",
    accountGroup: "GROUP_5",
    normalBalance: "CREDIT",
    level: 2,
  ...
  // ============================================================
  {
    ...
    nameEn: "Direct material costs",
    accountType: "EXPENSE",
    accountGroup: "GROUP_6",
    normalBalance: "DEBIT",
    level: 1,
    isSystemAccount: true,
  },
  ...
  },
  {
    ...
    nameEn: "Construction machinery costs",
    accountType: "EXPENSE",
    accountGroup: "GROUP_6",
    normalBalance: "DEBIT",
    level: 1,
  ...
  {
    accountNumber: "631",
    name: "Giá thành sản xuất",
    nameEn: "Cost of production",
    accountType: "EXPENSE",
    accountGroup: "GROUP_6",
    normalBalance: "DEBIT",
    level: 1,
...
export function getChildAccounts(parentAccountNumber: string): VASAccount[] {
  return VAS_CHART_OF_ACCOUNTS.filter(
    (a) => a.parentAccount === parentAccountNumber
  )
}
