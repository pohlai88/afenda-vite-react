...
router.get("/", authorize("promotions:read"), handlers.list)

router.get("/:id", authorize("promotions:read"), handlers.getById)
...
router.delete("/:id", authorize("promotions:delete"), handlers.remove)
