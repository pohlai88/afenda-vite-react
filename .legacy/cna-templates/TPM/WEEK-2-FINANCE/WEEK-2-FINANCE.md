  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-4 gap-4">
        ...
        <StatCard
          title="This Period"
          value={formatCurrency(summary.currentPeriod)}
        />
      </div>
            ...
            <Table>
              ...
              <TableFooter>
                <TableRow>
                  ...
                  <TableCell>
                    {formatCurrency(
                      preview.reduce((sum, e) => sum + e.amount, 0)
                    )}
                  </TableCell>
                </TableRow>
              </TableFooter>
        ...
        <CardContent className="space-y-4">
            ...
            >
              <div className="flex justify-between items-start">
                ...
                <div className="text-right">
                  ...
                  <Badge
                    variant={
                      suggestion.confidence > 0.8 ? "success" : "warning"
                    }
                  >
          ...
          {selectedClaim && (
            <Button
              className="w-full"
              onClick={() =>
                matchMutation.mutate({ id, claimId: selectedClaim })
              }
            >
