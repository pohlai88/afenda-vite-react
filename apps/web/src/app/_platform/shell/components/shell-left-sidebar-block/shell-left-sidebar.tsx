...
export type ShellLeftSidebarProps = {
  /** Rail chrome (widgets + links); labels column is the module explorer. */
  model: ShellLeftSidebarNavigationModelResult
...
/**
 * Desktop: static-width rail (`collapsible="none"`; labels explorer renders beside the inset).
