...
async function fetchStudioEnums() {
  const client = getSharedApiClient()
  return client.get<unknown>(resolveApiV1Path("/studio/enums"))
}
 ...
 */
export function prefetchDbStudioCatalog(queryClient: QueryClient): Promise<void> {
