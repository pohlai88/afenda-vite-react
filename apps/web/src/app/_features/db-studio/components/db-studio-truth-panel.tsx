  ...
  return (
    <Card className="overflow-hidden">
      ...
      <CardContent className="space-y-6">
        ...
        {empty ? (
          <p className="rounded-md border border-dashed border-muted-foreground/20 px-3 py-6 text-center text-sm text-muted-foreground">
...
function RegistryColumn(props: {
  ...
  return (
    <div className="min-h-[120px] rounded-lg border bg-muted/30 p-3">
