/**
 * JSON response envelopes for typed Hono RPC + manual `fetch` — mirrors `apps/api/src/contract/http-envelope.contract.ts` / `lib/response`.
 ...
 * stable
 * @module rpc/web-envelope.contract
 * @package @afenda/web
 */
import { z } from "zod"
