...
function SectionLabel(props: { readonly children: React.ReactNode }) {
  return (
    <div className="flex items-center gap-3 font-mono text-[10px] tracking-[0.28em] text-current/42 uppercase">
...
function TelemetryItem(props: {
  readonly label: string
  readonly value: string
}) {
  return (
    <div className="group flex items-center justify-between gap-6 border-b border-current/10 px-5 py-4 transition-colors last:border-b-0 hover:bg-current/5">
      <span className="font-mono text-[10px] tracking-[0.22em] text-current/42 uppercase transition-colors group-hover:text-current/60">
        {props.label}
      </span>
      <span className="text-sm tracking-[0.08em] text-current/88 uppercase transition-colors group-hover:text-current">
        {props.value}
      </span>
    </div>
  )
...
function ChamberCard(props: { readonly chamber: Chamber }) {
  ...
  return (
    <article className="group grid border-b border-white/10 bg-black transition-colors last:border-b-0 hover:bg-white/[0.02] md:grid-cols-[6rem_minmax(0,1fr)_20rem]">
      <div className="border-r border-white/10 px-4 py-5 font-mono text-[11px] tracking-[0.22em] text-white/42 uppercase transition-colors group-hover:text-white/70 md:px-5">
        {chamber.id}
      </div>
      ...
      <div className="px-5 py-6 md:px-7 md:py-7">
        <div className="mb-3 flex items-center gap-3">
          <span
            className="inline-block h-2 w-2 animate-pulse rounded-full bg-white/70"
        ...
        <h3 className="text-2xl font-semibold tracking-[-0.045em] uppercase md:text-4xl">
          {chamber.title}
        </h3>
      ...
      <div className="border-l border-white/10 px-5 py-6 md:py-7">
        <div className="space-y-3">
          {chamber.telemetry.map((item) => (
            <div
              key={item}
              className="flex items-center gap-3 font-mono text-[10px] tracking-[0.18em] text-white/48 uppercase"
            >
...
function ProofCard(props: { readonly panel: ProofPanel }) {
  ...
  return (
    <article className="group grid border border-black/10 bg-white transition-colors duration-300 hover:bg-black hover:text-white md:grid-rows-[auto_1fr_auto]">
      <div className="flex items-center justify-between border-b border-current/10 px-5 py-4">
        <span className="font-mono text-[10px] tracking-[0.24em] text-current/42 uppercase">
          {props.panel.id}
        </span>
      ...
      <div className="px-5 py-5">
        <h3 className="text-xl font-semibold tracking-[-0.03em] uppercase md:text-2xl">
          {props.panel.title}
        </h3>
      ...
      <div className="border-t border-current/10 px-5 py-4">
        <p className="font-mono text-[10px] leading-6 tracking-[0.18em] text-current/46 uppercase">
          {props.panel.detail}
        </p>
      </div>
    </article>
    ...
    <div className="min-h-screen overflow-hidden bg-black text-white selection:bg-white selection:text-black">
      ...
      <div className="relative min-h-screen">
        ...
        <div className="pointer-events-none absolute inset-0 overflow-hidden opacity-[0.08]">
          ...
          <div className="absolute top-[5.5rem] right-0 left-0 h-px bg-white/12 md:top-24" />
          <div className="absolute right-0 bottom-24 left-0 h-px bg-white/10" />

          {/* Active Radar Line */}
          <div className="animate-scan absolute right-0 left-0 h-[1px] bg-white shadow-[0_0_15px_rgba(255,255,255,1)]" />
        </div>
        ...
        <header className="relative z-10 border-b border-white/10 px-6 py-6 md:px-10 lg:px-12">
          <div className="flex items-center justify-between gap-6">
            ...
            <div className="hidden items-center gap-6 md:flex">
              <span className="font-mono text-[10px] tracking-[0.22em] text-white/38 uppercase">
                Border / Memory / Truth
              </span>
              <span className="flex items-center gap-2 font-mono text-[10px] tracking-[0.22em] text-white/80 uppercase">
        ...
        <main className="relative z-10 px-6 pt-10 pb-12 md:px-10 md:pt-14 lg:px-12 lg:pt-16">
          {/* HERO */}
          <section className="grid gap-12 lg:grid-cols-[minmax(0,1fr)_22rem] lg:gap-0">
            <div className="max-w-5xl pr-0 lg:pr-16">
              ...
              <h1 className="mt-8 text-[16vw] leading-[0.82] font-semibold tracking-[-0.08em] uppercase md:text-[10.8vw] lg:text-[8.2vw]">
                Assume
                <br />
                <span
              ...
              <div className="mt-10 grid gap-8 border-t border-white/10 pt-8 md:grid-cols-[minmax(0,1fr)_auto] md:items-end">
                <p className="max-w-2xl text-base leading-7 text-white/66 md:text-lg">
                  Black and white do not need to fight. In a correct system,
                  black holds memory, white holds proof, and the boundary
                  between them becomes judgment. AFENDA is built for businesses
                  that cannot afford decorative certainty.
                </p>

                <button className="group inline-flex items-center gap-3 border border-white/20 px-5 py-4 font-mono text-[11px] tracking-[0.24em] uppercase transition-all hover:border-white hover:bg-white hover:text-black active:scale-[0.98]">
            ...
            <aside className="lg:text-black">
              <div className="border border-white/10 bg-white/[0.02] backdrop-blur-sm lg:border-black/10 lg:bg-transparent lg:backdrop-blur-none">
                <div className="flex items-center justify-between border-b border-white/10 px-5 py-4 lg:border-black/10">
                  <span className="font-mono text-[10px] tracking-[0.24em] text-white/45 uppercase lg:text-black/45">
                    System Telemetry
                  </span>
                ...
                <div className="border-t border-white/10 px-5 py-5 lg:border-black/10">
                  <p className="font-mono text-[10px] tracking-[0.22em] text-white/42 uppercase lg:text-black/42">
          ...
          <section className="mt-14 border-t border-white/10 pt-6 lg:mt-16">
            <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
              {COMMAND_STRIP.map((item, index) => (
                ...
                >
                  <span className="font-mono text-[10px] tracking-[0.22em] text-current/42 uppercase group-hover:text-black/50">
                    {String(index + 1).padStart(2, "0")}
                  </span>
                  <span className="text-sm tracking-[0.1em] text-current/88 uppercase group-hover:font-bold group-hover:text-black">
                    {item}
                  </span>
                </div>
              ))}
          ...
          <section className="mt-16 border-t border-white/10 pt-8 lg:mt-20">
            <div className="mb-8 flex items-center justify-between gap-6">
              ...
              <span className="hidden font-mono text-[10px] tracking-[0.22em] text-white/34 uppercase md:block">
          ...
          <section className="mt-16 border-t border-white/10 pt-8 lg:mt-20">
            <div className="mb-8 grid gap-8 md:grid-cols-[minmax(0,1fr)_24rem] md:items-end">
              <div>
                ...
                <h2 className="mt-6 max-w-4xl text-3xl leading-[0.92] font-semibold tracking-[-0.05em] uppercase md:text-5xl lg:text-6xl">
              ...
              <p className="text-base leading-7 text-white/62">
                AFENDA should not merely process activity. It should expose
                doctrine, memory, resolution, and evidence as operating
                material.
              </p>
            </div>
          ...
          <section className="mt-16 border-t border-white/10 pt-8 lg:mt-20">
            <div className="grid gap-px bg-white/10 lg:grid-cols-[1.15fr_0.85fr]">
              <div className="bg-black px-6 py-8 md:px-8 md:py-10">
                ...
                <h2 className="mt-6 max-w-3xl text-3xl leading-[0.92] font-semibold tracking-[-0.05em] uppercase md:text-5xl">
                  Let black and white
                  <br />
                  share one doctrine.
                </h2>
              ...
              <div className="bg-white px-6 py-8 text-black md:px-8 md:py-10">
                <p className="text-base leading-7 text-black/68">
                  The interface should feel measured, not decorated. Quiet, not
                  empty. Severe, but not cold. This is where AFENDA stops
                  behaving like a website and starts behaving like a command
                  surface for enterprise truth.
                </p>

                <div className="mt-8 border-t border-black/10 pt-5 font-mono text-[10px] tracking-[0.18em] text-black/46 uppercase">
            ...
            <div className="grid gap-px bg-white/10 lg:grid-cols-[0.95fr_1.05fr]">
              <div className="bg-white px-6 py-8 text-black md:px-8 md:py-10">
                <div className="flex items-center justify-between border-b border-black/10 pb-4">
                  <span className="font-mono text-[10px] tracking-[0.24em] text-black/42 uppercase">
                    Terminal
                  </span>
                  <Database className="h-4 w-4 text-black/58" />
                </div>

                <div className="space-y-4 pt-6 font-mono text-[11px] tracking-[0.16em] uppercase">
                  <div className="text-black/78 opacity-80">
                    &gt; boot sequence: afenda.truth
                  </div>
                  <div className="text-black/78 opacity-80">
                    &gt; validating doctrine surface
                  </div>
                  <div className="text-black/78 opacity-80">
                    &gt; synchronizing enterprise memory
                  </div>
                  <div className="flex items-center gap-1.5">
                    <span className="font-semibold text-black">
                      &gt; status: calibrated
                    </span>
                    <span className="animate-cursor inline-block h-3 w-2 bg-black" />
                  </div>
                </div>
              </div>
              ...
              <div className="bg-black px-6 py-8 md:px-8 md:py-10">
                ...
                <h2 className="mt-6 text-3xl leading-[0.92] font-semibold tracking-[-0.05em] uppercase md:text-5xl">
                  Beyond borders.
                  <br />
                  Beyond assumptions.
                </h2>
                ...
                <p className="mt-6 max-w-2xl text-base leading-7 text-white/66">
                  Build on doctrine. Operate with evidence. Let the business
                  move without letting truth fracture.
                </p>

                <div className="mt-8 flex flex-wrap items-center gap-4">
                  <button className="group inline-flex items-center gap-3 border border-white/20 bg-white px-5 py-4 font-mono text-[11px] font-bold tracking-[0.24em] text-black uppercase transition-colors hover:border-white hover:bg-black hover:text-white">
                    <span>Enter AFENDA</span>
                    <ArrowUpRight className="h-4 w-4 transition-transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5" />
                  </button>

                  <button className="group inline-flex items-center gap-3 border border-white/10 px-5 py-4 font-mono text-[11px] tracking-[0.24em] text-white/72 uppercase transition-colors hover:border-white/30 hover:text-white">
