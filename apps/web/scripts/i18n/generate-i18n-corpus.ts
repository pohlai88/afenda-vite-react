 ...
 *
 * Mapping:
 *   apps/web/scripts/i18n/data/i18n-key-mapping.json maps upstream source terms (msgid)
 *   to Afenda canonical keys.
 *
 * Run from apps/web: `pnpm run i18n:generate-corpus`
 */
...
const dataDir = join(appRoot, "scripts", "i18n", "data")
const i18nLocalesDir = join(
  appRoot,
  "src",
  "app",
  "_platform",
