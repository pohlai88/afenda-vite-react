 ...
 * Coupling: `api-response` `failure()`; `c.get("requestId")` from `api-request-context` middleware.
 * stable
 * @module api-error-handler.middleware
 * @package @afenda/api
 */
...
import { loggerForContext } from "./api-logger.js"
