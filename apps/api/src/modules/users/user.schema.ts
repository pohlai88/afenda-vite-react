 ...
 * Schemas live in `contract/user`; this module re-exports for `@afenda/api` module boundaries.
 * module · validation · users
 * Upstream: `../contract/user`. Downstream: user.service, routes/users, Vitest.
 * Side effects: none.
