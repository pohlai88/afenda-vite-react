/**
 * `@afenda/api` process entry: layered env, DB pool, Better Auth, Hono `serve`.
 *
 * Shutdown hooks close the shared pool on SIGINT/SIGTERM. Port defaults to 3001 (`PORT` overrides).
 *
 * @module index
 */
