/**
 * Hono application factory: CORS, Better Auth, audit middleware, `/v1/*` BFF, studio, shell audit.
 *
 * Composes feature routers from `modules/*` and keeps only wiring + small helpers here.
 * Entry point: `index.ts` → `createApp(db, auth, pool)`.
 *
 * @module app
 */
...
import { createAuthCompanionModuleForApp } from "./modules/auth-companion/bootstrap/create-auth-companion-module-for-app.js"
import {
...
import { handleShellInteractionAudit } from "./modules/shell-interaction-audit/shell-interaction-audit.js"
import { registerStudioRoutes } from "./modules/studio/register-studio-routes.js"
import { auditContextMiddleware } from "./platform/middleware/audit-context.js"
import { trustedBrowserOrigins } from "./platform/cors/trusted-browser-origins.js"
