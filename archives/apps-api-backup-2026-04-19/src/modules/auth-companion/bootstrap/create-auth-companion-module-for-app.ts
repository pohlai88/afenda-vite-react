/**
 * Runtime wiring: Drizzle challenge repo + optional raw `pg` session read/revoke for Better Auth tables.
 *
 * When `db` is not a Drizzle database client, uses in-memory challenges and unavailable session storage.
 * Session list/revoke use a raw `pg.Pool` seam (CLI-managed schema), not Drizzle models.
 *
 * @module modules/auth-companion/bootstrap/create-auth-companion-module-for-app
 */
import type { Pool } from "pg"

import { createDrizzleAuthChallengeRepo } from "../../auth-companion-adapters/drizzle/index.js"
import {
  createPgBetterAuthSessionReader,
  createPgBetterAuthSessionRevoker,
} from "../../auth-companion-adapters/pg/index.js"
import {
  DEFAULT_BETTER_AUTH_PG_COLUMNS,
  DEFAULT_BETTER_AUTH_PG_TABLES,
} from "../../auth-companion-adapters/pg/repo/better-auth-pg-defaults.js"
import { isDatabaseClient } from "../../auth-companion-adapters/is-database-client.js"
import { createAuthCompanionModule } from "../create-auth-companion-module.js"
import { InMemoryAuthChallengeRepo } from "../repo/auth-challenge.repo.js"
import { UnavailableAuthSessionStorageRepo } from "../repo/auth-session.repo.js"
